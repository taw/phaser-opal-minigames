...
class MenuState < Phaser::State
  def preload
    (1..20).each do |i|
      $game.load.image("cat#{i}", "/assets/images/cat_images/cat#{i}.png")
    end
    $game.load.audio("meow", "/assets/audio/cat_meow.mp3")
    $game.load.image("menu", "/assets/images/buttons/menu.png")
    $game.load.image("button2x2", "/assets/images/buttons/play2x2.png")
    $game.load.image("button4x4", "/assets/images/buttons/play4x4.png")
    $game.load.image("button6x6", "/assets/images/buttons/play6x6.png")
  end
