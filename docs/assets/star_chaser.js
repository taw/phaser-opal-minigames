...
(function(Opal) {
  ...
  self.$require("app/star_chaser"+ '/../' + "common");
  (function($base, $super) {
    function $MainState(){};
    ...
    def.star_group = def.stars = def.coin = def.chaser = def.emitter = nil;
    Opal.defn(self, '$preload', function() {
      var self = this;
      if ($gvars.game == null) $gvars.game = nil;
    ...
    Opal.defn(self, '$add_star', function(x, y) {
      ...
      ((($a = x) !== false && $a !== nil) ? $a : x = $gvars.game.$rnd().$between(20, $rb_minus($gvars.size_x, 20)));
      ((($a = y) !== false && $a !== nil) ? $a : y = $gvars.game.$rnd().$between(20, $rb_minus($gvars.size_y, 20)));
      star = self.star_group.$create(x, y, "star");
      (($a = [true]), $b = star.$body(), $b['$immovable='].apply($b, $a), $a[$a.length-1]);
      return self.stars['$<<'](star);
    });

    Opal.defn(self, '$eat_star', function(star) {
      var $a, $b, TMP_1, self = this;

      star.$kill();
      ($a = ($b = self.stars).$delete_if, $a.$$p = (TMP_1 = function(s){var self = TMP_1.$$s || this, $a;
if (s == null) s = nil;
      return (($a = s.$x()['$=='](star.$x())) ? s.$y()['$=='](star.$y()) : s.$x()['$=='](star.$x()))}, TMP_1.$$s = self, TMP_1), $a).call($b);
      return self.coin.$play();
    });
    ...
    Opal.defn(self, '$create', function() {
      ...
      self.star_group = $gvars.game.$add().$group();
      (($a = [true]), $b = self.star_group, $b['$enable_body='].apply($b, $a), $a[$a.length-1]);
      self.stars = [];
      ($a = ($b = (10)).$times, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

      return self.$add_star()}, TMP_2.$$s = self, TMP_2), $a).call($b);
...
if (pointer == null) pointer = nil;if (event == null) event = nil;
      ...
      (($a = [0]), $d = self.emitter, $d['$gravity='].apply($d, $a), $a[$a.length-1]);
      return self.emitter.$set_alpha(0.2, 0.5, 0);
    });

    Opal.defn(self, '$clamped_vector', function(a, b, max_len) {
      var self = this, dx = nil, dy = nil, l = nil;

      if (b['$=='](nil)) {
        return [0, 0]};
      dx = $rb_minus(b.$x(), a.$x());
      dy = $rb_minus(b.$y(), a.$y());
      l = ($rb_plus(dx['$**'](2), dy['$**'](2)))['$**'](0.5);
      dx = $rb_divide($rb_times(dx, max_len), l);
      dy = $rb_divide($rb_times(dy, max_len), l);
      return [dx, dy];
    });

    return (Opal.defn(self, '$update', function() {
      var $a, $b, TMP_4, $c, TMP_5, $d, $e, self = this, nearest_star = nil, dx = nil, dy = nil;
      if ($gvars.game == null) $gvars.game = nil;

      nearest_star = ($a = ($b = self.stars).$min_by, $a.$$p = (TMP_4 = function(star){var self = TMP_4.$$s || this;
        if (self.chaser == null) self.chaser = nil;
...
if (c == null) c = nil;if (s == null) s = nil;
      ...
      if ((($a = ($d = $rb_lt(self.$rand(), $rb_times($gvars.game.$time().$physics_elapsed(), 10)), $d !== false && $d !== nil ?(((($e = dx['$!='](0)) !== false && $e !== nil) ? $e : dy['$!='](0))) : $d)) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        (($a = [$rb_times(-0.2, dx)]), $d = self.emitter.$minParticleSpeed(), $d['$x='].apply($d, $a), $a[$a.length-1]);
        (($a = [$rb_times(-0.2, dy)]), $d = self.emitter.$minParticleSpeed(), $d['$y='].apply($d, $a), $a[$a.length-1]);
        (($a = [$rb_times(-0.4, dx)]), $d = self.emitter.$maxParticleSpeed(), $d['$x='].apply($d, $a), $a[$a.length-1]);
        (($a = [$rb_times(-0.4, dy)]), $d = self.emitter.$maxParticleSpeed(), $d['$y='].apply($d, $a), $a[$a.length-1]);
        return self.emitter.$start(true, 1000, nil, 1);
        } else {
        return nil
      };
    }), nil) && 'update';
