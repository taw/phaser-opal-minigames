...
(function(Opal) {
  ...
  Opal.add_stubs(['$attr_accessor', '$graphics', '$add', '$line_style', '$draw_polygon', '$==', '$text', '$sprite', '$height=', '$width=', '$set', '$anchor', '$attr_reader', '$shuffle', '$to_a', '$map', '$shift', '$setup_grid', '$each', '$<', '$>=', '$c', '$[]', '$flip_cells', '$check_if_completed', '$-', '$+', '$click_cell', '$c=', '$tile', '$tile=', '$x', '$y', '$x=', '$y=', '$to_proc', '$/', '$*', '$new', '$game_won', '$text=', '$times', '$image', '$load', '$background_color=', '$stage', '$on', '$click', '$input', '$add_key', '$keyboard', '$keyboard_move_cell', '$round', '$<=', '$size_x', '$size_y', '$state']);
  self.$require("app/sliding_puzzle"+ '/../' + "common");
  (function($base, $super) {
    function $Tile(){};
    ...
    def.bg = def.tile = nil;
    self.$attr_accessor("c", "tile");

    return (Opal.defn(self, '$initialize', function(x, y, c) {
      var $a, $b, self = this;
      if ($gvars.game == null) $gvars.game = nil;

      self.c = c;
      self.bg = $gvars.game.$add().$graphics(x, y);
      self.bg.$line_style(2, 0, 1);
      self.bg.$draw_polygon(-96, -54, -96, 54, 96, 54, 96, -54, -96, -54);
      if (c['$=='](15)) {
        self.tile = $gvars.game.$add().$text(x, y, "")
        } else {
        self.tile = $gvars.game.$add().$sprite(x, y, "tile" + (c));
        (($a = [108]), $b = self.tile, $b['$height='].apply($b, $a), $a[$a.length-1]);
        (($a = [192]), $b = self.tile, $b['$width='].apply($b, $a), $a[$a.length-1]);
      };
      return self.tile.$anchor().$set(0.5, 0.5);
    }), nil) && 'initialize';
  })($scope.base, null);
  (function($base, $super) {
    function $Board(){};
    ...
    def.size_x = def.size_y = def.grid = nil;
    self.$attr_reader("game_won", "size_x", "size_y");

    Opal.defn(self, '$initialize', function() {
      var $a, $b, TMP_1, self = this, tiles = nil;

      self.size_x = 4;
      self.size_y = 4;
      if ((($a = true) !== nil && (!$a.$$is_boolean || $a == true))) {
        tiles = ($range(0, 15, false)).$to_a().$shuffle()
        } else {
        tiles = [0, 4, 8, 12, 1, 5, 9, 13, 2, 6, 10, 14, 3, 7, 15, 11]
      };
      self.content = ($a = ($b = ($range(0, self.size_x, true))).$map, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $a, $b, TMP_2;
        if (self.size_y == null) self.size_y = nil;

      return ($a = ($b = ($range(0, self.size_y, true))).$map, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

        return tiles.$shift()}, TMP_2.$$s = self, TMP_2), $a).call($b)}, TMP_1.$$s = self, TMP_1), $a).call($b);
      self.$setup_grid();
      self.status = "ready";
      return self.game_won = false;
    });

    Opal.defn(self, '$click_cell', function(x, y) {try {

      var $a, $b, TMP_3, self = this;

      ($a = ($b = [[$rb_minus(x, 1), y], [$rb_plus(x, 1), y], [x, $rb_minus(y, 1)], [x, $rb_plus(y, 1)]]).$each, $a.$$p = (TMP_3 = function(xx, yy){var self = TMP_3.$$s || this, $a, $b, $c, $d;
        if (self.size_x == null) self.size_x = nil;
        if (self.size_y == null) self.size_y = nil;
        if (self.grid == null) self.grid = nil;
if (xx == null) xx = nil;if (yy == null) yy = nil;
      if ((($a = ((($b = ((($c = ((($d = $rb_lt(xx, 0)) !== false && $d !== nil) ? $d : $rb_lt(yy, 0))) !== false && $c !== nil) ? $c : $rb_ge(xx, self.size_x))) !== false && $b !== nil) ? $b : $rb_ge(yy, self.size_y))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil;};
        if (self.grid['$[]'](xx)['$[]'](yy).$c()['$=='](15)) {
          self.$flip_cells(self.grid['$[]'](x)['$[]'](y), self.grid['$[]'](xx)['$[]'](yy));
    ...
    Opal.defn(self, '$keyboard_move_cell', function(dx, dy) {
      var $a, $b, TMP_4, $c, $d, $e, self = this, empty_x = nil, empty_y = nil, x = nil, y = nil;

      empty_x = nil;
      empty_y = nil;
      ($a = ($b = ($range(0, self.size_x, true))).$each, $a.$$p = (TMP_4 = function(x){var self = TMP_4.$$s || this, $a, $b, TMP_5;
        if (self.size_y == null) self.size_y = nil;
if (x == null) x = nil;
      return ($a = ($b = ($range(0, self.size_y, true))).$each, $a.$$p = (TMP_5 = function(y){var self = TMP_5.$$s || this;
          if (self.grid == null) self.grid = nil;
if (y == null) y = nil;
        if (self.grid['$[]'](x)['$[]'](y).$c()['$=='](15)) {
            empty_x = x;
            return empty_y = y;
            } else {
            return nil
          }}, TMP_5.$$s = self, TMP_5), $a).call($b)}, TMP_4.$$s = self, TMP_4), $a).call($b);
      x = $rb_minus(empty_x, dx);
      y = $rb_minus(empty_y, dy);
      if ((($a = ((($c = ((($d = ((($e = $rb_lt(x, 0)) !== false && $e !== nil) ? $e : $rb_lt(y, 0))) !== false && $d !== nil) ? $d : $rb_ge(x, self.size_x))) !== false && $c !== nil) ? $c : $rb_ge(y, self.size_y))) !== nil && (!$a.$$is_boolean || $a == true))) {
        return false};
      return self.$click_cell(x, y);
    });

    Opal.defn(self, '$flip_cells', function(a, b) {
      var $a, self = this;

      $a = [b.$c(), a.$c()], a['$c=']($a[0]), b['$c=']($a[1]), $a;
      $a = [b.$tile(), a.$tile()], a['$tile=']($a[0]), b['$tile=']($a[1]), $a;
      return $a = [b.$tile().$x(), b.$tile().$y(), a.$tile().$x(), a.$tile().$y()], a.$tile()['$x=']($a[0]), a.$tile()['$y=']($a[1]), b.$tile()['$x=']($a[2]), b.$tile()['$y=']($a[3]), $a;
    });

    Opal.defn(self, '$check_if_completed', function(x, y) {
      var $a, $b, TMP_6, self = this;

      if (($a = ($b = self.grid).$map, $a.$$p = (TMP_6 = function(row){var self = TMP_6.$$s || this, $a, $b;
if (row == null) row = nil;
      return ($a = ($b = row).$map, $a.$$p = "c".$to_proc(), $a).call($b)}, TMP_6.$$s = self, TMP_6), $a).call($b)['$==']([[0, 4, 8, 12], [1, 5, 9, 13], [2, 6, 10, 14], [3, 7, 11, 15]])) {
        return self.game_won = true
        } else {
        return nil
      };
    });

    return (Opal.defn(self, '$setup_grid', function() {
      var $a, $b, TMP_7, self = this;

      return self.grid = ($a = ($b = ($range(0, self.size_x, true))).$map, $a.$$p = (TMP_7 = function(x){var self = TMP_7.$$s || this, $a, $b, TMP_8;
        if (self.size_y == null) self.size_y = nil;
if (x == null) x = nil;
      return ($a = ($b = ($range(0, self.size_y, true))).$map, $a.$$p = (TMP_8 = function(y){var self = TMP_8.$$s || this, loc_x = nil, loc_y = nil;
          if (self.content == null) self.content = nil;
          if ($gvars.size_x == null) $gvars.size_x = nil;
          if ($gvars.size_y == null) $gvars.size_y = nil;
if (y == null) y = nil;
        loc_x = $rb_plus(($rb_minus($rb_divide($gvars.size_x, 2), $rb_times(192, 1.5))), $rb_times(192, x));
          loc_y = $rb_plus(($rb_minus($rb_divide($gvars.size_y, 2), $rb_times(108, 1.5))), $rb_times(108, y));
          return $scope.get('Tile').$new(loc_x, loc_y, self.content['$[]'](x)['$[]'](y));}, TMP_8.$$s = self, TMP_8), $a).call($b)}, TMP_7.$$s = self, TMP_7), $a).call($b);
    }), nil) && 'setup_grid';
  })($scope.base, null);
  (function($base, $super) {
    function $MainState(){};
    ...
    def.board = def.score = def.scoreText = nil;
    Opal.defn(self, '$update', function() {
      var $a, $b, self = this;

      if ((($a = self.board.$game_won()) !== nil && (!$a.$$is_boolean || $a == true))) {
        return (($a = ["Completed in " + (self.score) + " moves!"]), $b = self.scoreText, $b['$text='].apply($b, $a), $a[$a.length-1])
        } else {
    ...
    Opal.defn(self, '$preload', function() {
      ...
      return ($a = ($b = (16)).$times, $a.$$p = (TMP_9 = function(i){var self = TMP_9.$$s || this;
        if ($gvars.game == null) $gvars.game = nil;
if (i == null) i = nil;
      return $gvars.game.$load().$image("tile" + (i), "../images/sliding_puzzle/tile" + (i) + ".jpg")}, TMP_9.$$s = self, TMP_9), $a).call($b);
    });

    Opal.defn(self, '$create', function() {
      var $a, $b, TMP_10, $c, TMP_11, $d, TMP_12, $e, TMP_13, $f, TMP_14, self = this, left_key = nil, right_key = nil, up_key = nil, down_key = nil;
      if ($gvars.game == null) $gvars.game = nil;

      self.score = 0;
      self.scoreText = $gvars.game.$add().$text(16, 16, "", $hash2(["fontSize", "fill"], {"fontSize": "32px", "fill": "#fff"}));
      (($a = ["F88"]), $b = $gvars.game.$stage(), $b['$background_color='].apply($b, $a), $a[$a.length-1]);
      self.board = $scope.get('Board').$new();
      ($a = ($b = $gvars.game.$input()).$on, $a.$$p = (TMP_10 = function(pointer, ev){var self = TMP_10.$$s || this;
if (pointer == null) pointer = nil;if (ev == null) ev = nil;
      return self.$click(pointer.x, pointer.y)}, TMP_10.$$s = self, TMP_10), $a).call($b, "down");
      left_key = $gvars.game.$input().$keyboard().$add_key(Phaser.KeyCode.LEFT);
      ($a = ($c = left_key).$on, $a.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this, $a;
        if (self.board == null) self.board = nil;
        if (self.score == null) self.score = nil;

      if ((($a = self.board.$game_won()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return ($breaker.$v = nil, $breaker)};
        if ((($a = self.board.$keyboard_move_cell(-1, 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.score = $rb_plus(self.score, 1)
          } else {
          return nil
        };}, TMP_11.$$s = self, TMP_11), $a).call($c, "down");
      right_key = $gvars.game.$input().$keyboard().$add_key(Phaser.KeyCode.RIGHT);
      ($a = ($d = right_key).$on, $a.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this, $a;
        if (self.board == null) self.board = nil;
        if (self.score == null) self.score = nil;
      ...
      if ((($a = self.board.$game_won()) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        if ((($a = self.board.$keyboard_move_cell(1, 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          return nil
        };}, TMP_12.$$s = self, TMP_12), $a).call($d, "down");
      up_key = $gvars.game.$input().$keyboard().$add_key(Phaser.KeyCode.UP);
      ($a = ($e = up_key).$on, $a.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this, $a;
        if (self.board == null) self.board = nil;
        if (self.score == null) self.score = nil;

      if ((($a = self.board.$game_won()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return ($breaker.$v = nil, $breaker)};
        if ((($a = self.board.$keyboard_move_cell(0, -1)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.score = $rb_plus(self.score, 1)
          } else {
          return nil
        };}, TMP_13.$$s = self, TMP_13), $a).call($e, "down");
      down_key = $gvars.game.$input().$keyboard().$add_key(Phaser.KeyCode.DOWN);
      return ($a = ($f = down_key).$on, $a.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this, $a;
        if (self.board == null) self.board = nil;
        if (self.score == null) self.score = nil;
      ...
      if ((($a = self.board.$game_won()) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        if ((($a = self.board.$keyboard_move_cell(0, 1)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          return nil
        };}, TMP_14.$$s = self, TMP_14), $a).call($f, "down");
    });

    return (Opal.defn(self, '$click', function(x, y) {
      var $a, $b, $c, $d, self = this;
      if ($gvars.size_x == null) $gvars.size_x = nil;
      if ($gvars.size_y == null) $gvars.size_y = nil;
      ...
      if ((($a = self.board.$game_won()) !== nil && (!$a.$$is_boolean || $a == true))) {
        return nil};
      x = ($rb_divide(($rb_plus($rb_minus(x, $rb_divide($gvars.size_x, 2)), $rb_times(192, 1.5))), 192)).$round();
      y = ($rb_divide(($rb_plus($rb_minus(y, $rb_divide($gvars.size_y, 2)), $rb_times(108, 1.5))), 108)).$round();
      if ((($a = ($b = ($c = ($d = $rb_ge(x, 0), $d !== false && $d !== nil ?$rb_le(x, $rb_minus(self.board.$size_x(), 1)) : $d), $c !== false && $c !== nil ?$rb_ge(y, 0) : $c), $b !== false && $b !== nil ?$rb_le(y, $rb_minus(self.board.$size_y(), 1)) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        if ((($a = self.board.$click_cell(x, y)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.score = $rb_plus(self.score, 1)
          } else {
          return nil
        }
