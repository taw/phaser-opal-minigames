...
(function(Opal) {
  ...
  Opal.add_stubs(['$text', '$add', '$map', '$new_cell', '$background_color=', '$stage', '$graphics', '$/', '$line_style', '$move_to', '$line_to', '$on', '$click', '$input', '$+', '$-', '$*', '$set', '$anchor', '$==', '$floor', '$p', '$include?', '$click_cell', '$restart', '$state', '$!=', '$[]', '$[]=', '$check_who_won', '$ai_movement', '$between', '$rnd', '$each', '$text=', '$===', '$new']);
  self.$require("app/tic_tac_toe"+ '/../' + "common");
  (function($base, $super) {
    function $MainState(){};
    ...
    def.grid = def.winner = def.content = def.winnerText = nil;
    Opal.defn(self, '$create', function() {
      ...
      self.winner = nil;
      self.winnerText = $gvars.game.$add().$text(16, 16, "", $hash2(["fontSize", "fill"], {"fontSize": "32px", "fill": "#fff"}));
      self.content = ($a = ($b = ($range(0, 2, false))).$map, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $a, $b, TMP_2;

      return ($a = ($b = ($range(0, 2, false))).$map, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

        return "?"}, TMP_2.$$s = self, TMP_2), $a).call($b)}, TMP_1.$$s = self, TMP_1), $a).call($b);
      self.content_cells = ($a = ($c = ($range(0, 2, false))).$map, $a.$$p = (TMP_3 = function(x){var self = TMP_3.$$s || this, $a, $b, TMP_4;
if (x == null) x = nil;
      return ($a = ($b = ($range(0, 2, false))).$map, $a.$$p = (TMP_4 = function(y){var self = TMP_4.$$s || this;
if (y == null) y = nil;
        return self.$new_cell(x, y)}, TMP_4.$$s = self, TMP_4), $a).call($b)}, TMP_3.$$s = self, TMP_3), $a).call($c);
      (($a = ["F88"]), $d = $gvars.game.$stage(), $d['$background_color='].apply($d, $a), $a[$a.length-1]);
      self.grid = $gvars.game.$add().$graphics($rb_divide($gvars.size_x, 2), $rb_divide($gvars.size_y, 2));
      self.grid.$line_style(5, "red");
      self.grid.$move_to(-300, 100);
      self.grid.$line_to(300, 100);
      self.grid.$move_to(-300, -100);
      self.grid.$line_to(300, -100);
      self.grid.$move_to(-100, -300);
      self.grid.$line_to(-100, 300);
      self.grid.$move_to(100, -300);
      self.grid.$line_to(100, 300);
      return ($a = ($d = $gvars.game.$input()).$on, $a.$$p = (TMP_5 = function(pointer, ev){var self = TMP_5.$$s || this;
if (pointer == null) pointer = nil;if (ev == null) ev = nil;
      return self.$click(pointer.x, pointer.y)}, TMP_5.$$s = self, TMP_5), $a).call($d, "down");
    });

    Opal.defn(self, '$new_cell', function(x, y) {
      var self = this, text = nil;
      if ($gvars.game == null) $gvars.game = nil;
      if ($gvars.size_x == null) $gvars.size_x = nil;
      if ($gvars.size_y == null) $gvars.size_y = nil;

      text = $gvars.game.$add().$text($rb_plus($rb_minus($rb_divide($gvars.size_x, 2), 200), $rb_times(200, x)), $rb_plus($rb_minus($rb_divide($gvars.size_y, 2), 200), $rb_times(200, y)), "", $hash2(["font", "fill", "align"], {"font": "64px Arial", "fill": "000", "align": "center"}));
      text.$anchor().$set(0.5);
      return text;
    });

    Opal.defn(self, '$click', function(x, y) {
      var $a, $b, self = this, cell_x = nil, cell_y = nil;
      if ($gvars.size_x == null) $gvars.size_x = nil;
      if ($gvars.size_y == null) $gvars.size_y = nil;
      if ($gvars.game == null) $gvars.game = nil;

      if (self.winner['$=='](nil)) {
        cell_x = ($rb_divide(($rb_plus($rb_minus(x, $rb_divide($gvars.size_x, 2)), 300)), 200)).$floor();
        cell_y = ($rb_divide(($rb_plus($rb_minus(y, $rb_divide($gvars.size_y, 2)), 300)), 200)).$floor();
        self.$p([x, y, cell_x, cell_y]);
        if ((($a = ($b = ($range(0, 2, false))['$include?'](cell_x), $b !== false && $b !== nil ?($range(0, 2, false))['$include?'](cell_y) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.$click_cell(cell_x, cell_y)
          } else {
          return nil
        };
        } else {
        return $gvars.game.$state().$restart()
      };
    });
    ...
    Opal.defn(self, '$click_cell', function(x, y) {
      ...
      if ((($a = self.winner['$!='](nil)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return nil};
      if (self.content['$[]'](x)['$[]'](y)['$==']("?")) {
        self.content['$[]'](x)['$[]='](y, "X");
        self.$check_who_won();
    ...
    Opal.defn(self, '$ai_movement', function() {
      ...
      x = $gvars.game.$rnd().$between(0, 2);
      y = $gvars.game.$rnd().$between(0, 2);
      if (self.content['$[]'](x)['$[]'](y)['$==']("?")) {
        self.content['$[]'](x)['$[]='](y, "O");
        break;;};};
    });
    ...
    Opal.defn(self, '$update', function() {
      var $a, $b, TMP_6, $c, self = this, $case = nil;

      ($a = ($b = ($range(0, 2, false))).$each, $a.$$p = (TMP_6 = function(x){var self = TMP_6.$$s || this, $a, $b, TMP_7;
if (x == null) x = nil;
      return ($a = ($b = ($range(0, 2, false))).$each, $a.$$p = (TMP_7 = function(y){var self = TMP_7.$$s || this, $a, $b;
          if (self.content == null) self.content = nil;
          if (self.content_cells == null) self.content_cells = nil;
if (y == null) y = nil;
        return (($a = [self.content['$[]'](x)['$[]'](y)]), $b = self.content_cells['$[]'](x)['$[]'](y), $b['$text='].apply($b, $a), $a[$a.length-1])}, TMP_7.$$s = self, TMP_7), $a).call($b)}, TMP_6.$$s = self, TMP_6), $a).call($b);
      return (function() {$case = self.winner;if ("X"['$===']($case)) {return (($a = ["X won"]), $c = self.winnerText, $c['$text='].apply($c, $a), $a[$a.length-1])}else if ("O"['$===']($case)) {return (($a = ["O won"]), $c = self.winnerText, $c['$text='].apply($c, $a), $a[$a.length-1])}else if ("Draw"['$===']($case)) {return (($a = ["DRAW"]), $c = self.winnerText, $c['$text='].apply($c, $a), $a[$a.length-1])}else {return (($a = ["Game goes on"]), $c = self.winnerText, $c['$text='].apply($c, $a), $a[$a.length-1])}})();
    });

    return (Opal.defn(self, '$check_who_won', function() {
      var $a, $b, TMP_8, $c, TMP_10, self = this, lines = nil;

      lines = [[[0, 0], [1, 0], [2, 0]], [[0, 1], [1, 1], [2, 1]], [[0, 2], [1, 2], [2, 2]], [[0, 0], [0, 1], [0, 2]], [[1, 0], [1, 1], [1, 2]], [[2, 0], [2, 1], [2, 2]], [[0, 0], [1, 1], [2, 2]], [[2, 0], [1, 1], [0, 2]]];
      ($a = ($b = lines).$each, $a.$$p = (TMP_8 = function(line){var self = TMP_8.$$s || this, $a, $b, TMP_9, values = nil;
if (line == null) line = nil;
      values = ($a = ($b = line).$map, $a.$$p = (TMP_9 = function(x, y){var self = TMP_9.$$s || this;
          if (self.content == null) self.content = nil;
if (x == null) x = nil;if (y == null) y = nil;
        return self.content['$[]'](y)['$[]'](x)}, TMP_9.$$s = self, TMP_9), $a).call($b);
        if (values['$=='](["X", "X", "X"])) {
          self.winner = "X"};
        if (values['$=='](["O", "O", "O"])) {
      ...
      if (self.winner['$=='](nil)) {
        self.winner = "Draw";
        return ($a = ($c = ($range(0, 2, false))).$each, $a.$$p = (TMP_10 = function(y){var self = TMP_10.$$s || this, $a, $b, TMP_11;
if (y == null) y = nil;
        return ($a = ($b = ($range(0, 2, false))).$each, $a.$$p = (TMP_11 = function(x){var self = TMP_11.$$s || this;
            if (self.content == null) self.content = nil;
if (x == null) x = nil;
          if (self.content['$[]'](y)['$[]'](x)['$==']("?")) {
              ...
              return nil
            }}, TMP_11.$$s = self, TMP_11), $a).call($b)}, TMP_10.$$s = self, TMP_10), $a).call($c);
        } else {
        return nil
      };
    }), nil) && 'check_who_won';
