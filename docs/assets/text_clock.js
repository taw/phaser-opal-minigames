...
(function(Opal) {
  ...
  Opal.add_stubs(['$*', '$deg_to_rad', '$math', '$x=', '$+', '$/', '$sin', '$y=', '$-', '$cos', '$angle=', '$==', '$fill=', '$fontSize=', '$text', '$add', '$set', '$anchor', '$background_color=', '$stage', '$map', '$create_label', '$times', '$min', '$new', '$to_i', '$each_with_index', '$update_label', '$[]', '$sec', '$hour', '$state']);
  self.$require("app/text_clock"+ '/../' + "common");
  (function($base, $super) {
    function $MainState(){};
    ...
    def.last_time = def.seconds = def.minutes = def.hours = nil;
    Opal.defn(self, '$update_label', function(label, distance, angle_ratio) {
      var $a, $b, self = this, angle_deg = nil, a = nil;
      if ($gvars.game == null) $gvars.game = nil;
      if ($gvars.size_x == null) $gvars.size_x = nil;
      if ($gvars.size_y == null) $gvars.size_y = nil;

      angle_deg = $rb_times(360, angle_ratio);
      a = $gvars.game.$math().$deg_to_rad(angle_deg);
      (($a = [$rb_plus($rb_divide($gvars.size_x, 2), $rb_times(distance, $scope.get('Math').$sin(a)))]), $b = label, $b['$x='].apply($b, $a), $a[$a.length-1]);
      (($a = [$rb_minus($rb_divide($gvars.size_y, 2), $rb_times(distance, $scope.get('Math').$cos(a)))]), $b = label, $b['$y='].apply($b, $a), $a[$a.length-1]);
      (($a = [angle_deg]), $b = label, $b['$angle='].apply($b, $a), $a[$a.length-1]);
      if (a['$=='](0)) {
        (($a = ["#44ff00"]), $b = label, $b['$fill='].apply($b, $a), $a[$a.length-1]);
        return (($a = [15]), $b = label, $b['$fontSize='].apply($b, $a), $a[$a.length-1]);
        } else {
        (($a = ["#ff0044"]), $b = label, $b['$fill='].apply($b, $a), $a[$a.length-1]);
        return (($a = [10]), $b = label, $b['$fontSize='].apply($b, $a), $a[$a.length-1]);
      };
    });

    Opal.defn(self, '$create_label', function(i) {
      var self = this, text = nil;
      if ($gvars.game == null) $gvars.game = nil;

      text = $gvars.game.$add().$text(0, 0, "" + (i), $hash2(["font", "fill", "align"], {"font": "10px Arial", "fill": "#ff0044", "align": "center"}));
      text.$anchor().$set(0.5);
      return text;
    });
    ...
    Opal.defn(self, '$create', function() {
      ...
      self.hours = ($a = ($b = (24).$times()).$map, $a.$$p = (TMP_1 = function(i){var self = TMP_1.$$s || this;
if (i == null) i = nil;
      return self.$create_label(i)}, TMP_1.$$s = self, TMP_1), $a).call($b);
      self.minutes = ($a = ($c = (60).$times()).$map, $a.$$p = (TMP_2 = function(i){var self = TMP_2.$$s || this;
if (i == null) i = nil;
      return self.$create_label(i)}, TMP_2.$$s = self, TMP_2), $a).call($c);
      self.seconds = ($a = ($d = (60).$times()).$map, $a.$$p = (TMP_3 = function(i){var self = TMP_3.$$s || this;
if (i == null) i = nil;
      return self.$create_label(i)}, TMP_3.$$s = self, TMP_3), $a).call($d);
      return self.screen_size = [$gvars.size_x, $gvars.size_y].$min();
    });

    return (Opal.defn(self, '$update', function() {
      var $a, $b, TMP_4, $c, TMP_5, $d, TMP_6, self = this, time = nil;

      time = $scope.get('Time').$new();
      if ((($a = ($b = self.last_time, $b !== false && $b !== nil ?time.$to_i()['$=='](self.last_time.$to_i()) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return nil};
      self.last_time = time;
      ($a = ($b = self.seconds).$each_with_index, $a.$$p = (TMP_4 = function(s, i){var self = TMP_4.$$s || this;
        if (self.seconds == null) self.seconds = nil;
        if (self.screen_size == null) self.screen_size = nil;
if (s == null) s = nil;if (i == null) i = nil;
      return self.$update_label(self.seconds['$[]'](i), $rb_times(0.4, self.screen_size), $rb_divide(($rb_minus(i, time.$sec())), 60.0))}, TMP_4.$$s = self, TMP_4), $a).call($b);
      ($a = ($c = self.minutes).$each_with_index, $a.$$p = (TMP_5 = function(s, i){var self = TMP_5.$$s || this;
        if (self.minutes == null) self.minutes = nil;
        if (self.screen_size == null) self.screen_size = nil;
if (s == null) s = nil;if (i == null) i = nil;
      return self.$update_label(self.minutes['$[]'](i), $rb_times(0.3, self.screen_size), $rb_divide(($rb_minus(i, time.$min())), 60.0))}, TMP_5.$$s = self, TMP_5), $a).call($c);
      return ($a = ($d = self.hours).$each_with_index, $a.$$p = (TMP_6 = function(s, i){var self = TMP_6.$$s || this;
        if (self.hours == null) self.hours = nil;
        if (self.screen_size == null) self.screen_size = nil;
if (s == null) s = nil;if (i == null) i = nil;
      return self.$update_label(self.hours['$[]'](i), $rb_times(0.2, self.screen_size), $rb_divide(($rb_minus(i, time.$hour())), 24.0))}, TMP_6.$$s = self, TMP_6), $a).call($d);
    }), nil) && 'update';
