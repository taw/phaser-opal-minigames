...
(function(Opal) {
  ...
  Opal.add_stubs(['$sprite', '$add', '$between', '$rnd', '$-', '$y=', '$+', '$y', '$*', '$>', '$/', '$x=', '$x', '$image', '$load', '$background_color=', '$stage', '$map', '$new', '$times', '$physics_elapsed', '$time', '$each', '$update', '$state']);
  self.$require("app/rain"+ '/../' + "common");
  (function($base, $super) {
    function $Raindrop(){};
    var self = $Raindrop = $klass($base, $super, 'Raindrop', $Raindrop);

    var def = self.$$proto, $scope = self.$$scope;

    def.raindrop = def.speed = nil;
    Opal.defn(self, '$initialize', function() {
      var self = this;
      if ($gvars.game == null) $gvars.game = nil;
      if ($gvars.size_x == null) $gvars.size_x = nil;

      self.raindrop = $gvars.game.$add().$sprite($gvars.game.$rnd().$between(0, $rb_minus($gvars.size_x, 24)), $gvars.game.$rnd().$between(0, $rb_minus($gvars.size_x, 22)), "raindrop");
    ...
    return (Opal.defn(self, '$update', function(time) {
      ...
      ($a = self.raindrop, $a['$y=']($rb_plus($a.$y(), $rb_times(self.speed, time))));
      if ((($a = $rb_gt(self.raindrop.$y(), $rb_minus($gvars.size_y, 5))) !== nil && (!$a.$$is_boolean || $a == true))) {
        return (($a = [0]), $b = self.raindrop, $b['$y='].apply($b, $a), $a[$a.length-1])
        } else {
        return nil
      };
    }), nil) && 'update';
  ...
  (function($base, $super) {
    function $Cloud(){};
    var self = $Cloud = $klass($base, $super, 'Cloud', $Cloud);

    var def = self.$$proto, $scope = self.$$scope;

    def.cloud = def.speed = nil;
    Opal.defn(self, '$initialize', function() {
      var self = this;
      if ($gvars.game == null) $gvars.game = nil;
      if ($gvars.size_x == null) $gvars.size_x = nil;
      ...
      self.cloud = $gvars.game.$add().$sprite($gvars.game.$rnd().$between(0, $rb_minus($gvars.size_x, 24)), $gvars.game.$rnd().$between(0, $rb_divide($gvars.size_y, 6)), "cloud");
      return self.speed = $gvars.game.$rnd().$between(100, 200);
    });
    ...
    return (Opal.defn(self, '$update', function(time) {
      ...
      ($a = self.cloud, $a['$x=']($rb_plus($a.$x(), $rb_times(self.speed, time))));
      if ((($a = $rb_gt(self.cloud.$x(), $rb_minus($gvars.size_x, 5))) !== nil && (!$a.$$is_boolean || $a == true))) {
        return (($a = [-256]), $b = self.cloud, $b['$x='].apply($b, $a), $a[$a.length-1])
        } else {
        return nil
      };
    }), nil) && 'update';
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$preload', function() {
      ...
      $gvars.game.$load().$image("raindrop", "/images/raindrop.png");
      return $gvars.game.$load().$image("cloud", "/images/cloud.png");
    });
    ...
    Opal.defn(self, '$create', function() {
      ...
      (($a = ["F7825D"]), $b = $gvars.game.$stage(), $b['$background_color='].apply($b, $a), $a[$a.length-1]);
      self.elements = ($a = ($b = (50).$times()).$map, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;

      return $scope.get('Raindrop').$new()}, TMP_1.$$s = self, TMP_1), $a).call($b);
      return self.elements = $rb_plus(self.elements, ($a = ($c = (6).$times()).$map, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

      return $scope.get('Cloud').$new()}, TMP_2.$$s = self, TMP_2), $a).call($c));
    });
    ...
    return (Opal.defn(self, '$update', function() {
      ...
      return ($a = ($b = self.elements).$each, $a.$$p = (TMP_3 = function(element){var self = TMP_3.$$s || this;
if (element == null) element = nil;
      return element.$update(dt)}, TMP_3.$$s = self, TMP_3), $a).call($b);
    }), nil) && 'update';
