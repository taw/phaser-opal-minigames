...
Opal.modules["opal/jquery/element"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_15, TMP_16, TMP_17, TMP_18, TMP_19, TMP_20, TMP_21, TMP_22, TMP_25, TMP_26, TMP_27, TMP_28, TMP_29, TMP_30, TMP_31, TMP_32, TMP_33, TMP_34, TMP_35, TMP_36, TMP_37, TMP_38, TMP_39, TMP_40, TMP_42, TMP_43, TMP_44, TMP_45, TMP_46, TMP_47, TMP_48, TMP_49;
...
if (method == null) method = nil;
    ...
    Opal.defn(self, '$prop', TMP_8 = function $$prop($a_rest) {
      var $b, self = this, args;
      ...
      return ($b = $scope.get('Native')).$call.apply($b, [self, "prop"].concat(Opal.to_a(args)));
    }, TMP_8.$$arity = -1);
    ...
    Opal.defn(self, '$to_n', TMP_9 = function $$to_n() {
      var self = this;

      return self;
    }, TMP_9.$$arity = 0);

    Opal.defn(self, '$[]', TMP_10 = function(name) {
      var self = this;
    ...
    Opal.defn(self, '$[]=', TMP_11 = function(name, value) {
      var $a, self = this;
    ...
    Opal.defn(self, '$attr', TMP_12 = function $$attr($a_rest) {
      var self = this, args;
    ...
    Opal.defn(self, '$has_attribute?', TMP_13 = function(name) {
      var self = this;

      return self.attr(name) !== undefined;
    }, TMP_13.$$arity = 1);

    Opal.defn(self, '$append_to_body', TMP_14 = function $$append_to_body() {
      var self = this;

      return self.appendTo(document.body);
    }, TMP_14.$$arity = 0);

    Opal.defn(self, '$append_to_head', TMP_15 = function $$append_to_head() {
      var self = this;

      return self.appendTo(document.head);
    }, TMP_15.$$arity = 0);

    Opal.defn(self, '$at', TMP_16 = function $$at(index) {
      var self = this;
    ...
    Opal.defn(self, '$class_name', TMP_17 = function $$class_name() {
      var self = this;
    ...
    Opal.defn(self, '$class_name=', TMP_18 = function(name) {
      var self = this;
    ...
    Opal.defn(self, '$css', TMP_19 = function $$css(name, value) {
      var $a, $b, self = this;
    ...
    Opal.defn(self, '$animate', TMP_20 = function $$animate(params) {
      var $a, self = this, $iter = TMP_20.$$p, block = $iter || nil, speed = nil;
    ...
    Opal.defn(self, '$data', TMP_21 = function $$data($a_rest) {
      var self = this, args;
      ...
      if (
        (typeof(result) === 'object') && !(result instanceof $scope.get('JQUERY_CLASS'))
      ) {
        result = $scope.get('JSON').$from_object(result);
      }
      return result == null ? nil : result;
    ;
    }, TMP_21.$$arity = -1);

    Opal.defn(self, '$effect', TMP_22 = function $$effect(name, $a_rest) {
      var $b, $c, TMP_23, $d, TMP_24, self = this, args, $iter = TMP_22.$$p, block = $iter || nil;
      ...
      TMP_22.$$p = null;
      name = ($b = ($c = name).$gsub, $b.$$p = (TMP_23 = function(match){var self = TMP_23.$$s || this;
if (match == null) match = nil;
      return match['$[]'](1).$upcase()}, TMP_23.$$s = self, TMP_23.$$arity = 1, TMP_23), $b).call($c, /_\w/);
      args = ($b = ($d = args).$map, $b.$$p = (TMP_24 = function(a){var self = TMP_24.$$s || this, $a;
if (a == null) a = nil;
      if ((($a = a['$respond_to?']("to_n")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return a.$to_n()
          } else {
          return nil
        }}, TMP_24.$$s = self, TMP_24.$$arity = 1, TMP_24), $b).call($d).$compact();
    ...
    Opal.defn(self, '$visible?', TMP_25 = function() {
      var self = this;

      return self.is(':visible');
    }, TMP_25.$$arity = 0);

    Opal.defn(self, '$offset', TMP_26 = function $$offset() {
      var self = this;

      return self.$Native(self.offset());
    }, TMP_26.$$arity = 0);

    Opal.defn(self, '$each', TMP_27 = function $$each() {
    ...
    Opal.defn(self, '$first', TMP_28 = function $$first() {
      var self = this;

      return self.length ? self.first() : nil;
    }, TMP_28.$$arity = 0);

    Opal.defn(self, '$html', TMP_29 = function $$html(content) {
      var self = this;
    ...
    Opal.defn(self, '$id=', TMP_31 = function(id) {
      var self = this;
    ...
    Opal.defn(self, '$tag_name', TMP_32 = function $$tag_name() {
      var self = this;

      return self.length > 0 ? self[0].tagName.toLowerCase() : nil;
    }, TMP_32.$$arity = 0);

    Opal.defn(self, '$inspect', TMP_33 = function $$inspect() {
      var self = this;
    ...
    Opal.defn(self, '$to_s', TMP_34 = function $$to_s() {
      var self = this;
    ...
    Opal.defn(self, '$length', TMP_35 = function $$length() {
      var self = this;

      return self.length;
    }, TMP_35.$$arity = 0);

    Opal.defn(self, '$any?', TMP_36 = function() {
      var self = this;

      return self.length > 0;
    }, TMP_36.$$arity = 0);

    Opal.defn(self, '$empty?', TMP_37 = function() {
      var self = this;
    ...
    Opal.defn(self, '$on', TMP_38 = function $$on(name, sel) {
      ...
      var wrapper = function() {
        ...
        if (has_args && args[0].preventDefault) {
          args[0] = $scope.get('Event').$new(args[0]);
        }
    ...
    Opal.defn(self, '$one', TMP_39 = function $$one(name, sel) {
      var self = this, $iter = TMP_39.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$off', TMP_40 = function $$off(name, sel, block) {
      var self = this;
    ...
    Opal.defn(self, '$serialize_array', TMP_42 = function $$serialize_array() {
      var $a, $b, TMP_41, self = this;

      return ($a = ($b = (self.serializeArray())).$map, $a.$$p = (TMP_41 = function(e){var self = TMP_41.$$s || this;
if (e == null) e = nil;
      return $scope.get('Hash').$new(e)}, TMP_41.$$s = self, TMP_41.$$arity = 1, TMP_41), $a).call($b);
    }, TMP_42.$$arity = 0);

    Opal.alias(self, 'size', 'length');

    Opal.defn(self, '$value', TMP_43 = function $$value() {
      var $a, self = this;

      return ((($a = self.val()) !== false && $a !== nil && $a != null) ? $a : "");
    }, TMP_43.$$arity = 0);

    Opal.defn(self, '$height', TMP_44 = function $$height() {
      var $a, self = this;

      return ((($a = self.height()) !== false && $a !== nil && $a != null) ? $a : nil);
    }, TMP_44.$$arity = 0);

    Opal.defn(self, '$width', TMP_45 = function $$width() {
      var $a, self = this;

      return ((($a = self.width()) !== false && $a !== nil && $a != null) ? $a : nil);
    }, TMP_45.$$arity = 0);

    Opal.defn(self, '$position', TMP_46 = function $$position() {
      var self = this;

      return self.$Native(self.position());
    }, TMP_46.$$arity = 0);

    Opal.defn(self, '$==', TMP_47 = function(other) {
      var self = this;

      return self.is(other);
    }, TMP_47.$$arity = 1);

    Opal.defn(self, '$respond_to_missing?', TMP_48 = function(name, _) {
      var $a, $b, self = this, $iter = TMP_48.$$p, $yield = $iter || nil, $zuper = nil, $zuper_index = nil, $zuper_length = nil;
      ...
      if (typeof(method) === 'function') {
        ...
        return ($a = ($b = self, Opal.find_super_dispatcher(self, 'respond_to_missing?', TMP_48, false)), $a.$$p = $iter, $a).apply($b, $zuper);
      }
    ;
    }, TMP_48.$$arity = 2);

    return (Opal.defn(self, '$method_missing', TMP_49 = function $$method_missing(name, $a_rest) {
      var $b, $c, self = this, args, $iter = TMP_49.$$p, block = $iter || nil, $zuper = nil, $zuper_index = nil, $zuper_length = nil;
      ...
      if (typeof(method) === 'function') {
        ...
        return ($b = ($c = self, Opal.find_super_dispatcher(self, 'method_missing', TMP_49, false)), $b.$$p = $iter, $b).apply($c, $zuper);
      }
    ;
    }, TMP_49.$$arity = -2), nil) && 'method_missing';
...
Opal.modules["opal/jquery/window"] = function(Opal) {
  ...
  (function($base) {
    ...
    (function($base, $super) {
      ...
      def.element = nil;
      self.$include((function() {if ((($a = (function(){ try { return (((($scope.get('Native')).$$scope.get('Wrapper'))) != null ? 'constant' : nil); } catch (err) { if (err.$$class === Opal.NameError) { return nil; } else { throw(err); }}; })()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return (($scope.get('Native')).$$scope.get('Wrapper'))
        } else {
        return $scope.get('Native')
      }; return nil; })());
...
Opal.modules["opal/jquery/http"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_14, TMP_15, TMP_16;
...
if (action == null) action = nil;
    ...
    Opal.defn(self, '$promise', TMP_14 = function $$promise() {
      var $a, $b, TMP_12, self = this;

      if ((($a = self.promise) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return self.promise};
      return self.promise = ($a = ($b = $scope.get('Promise').$new()).$tap, $a.$$p = (TMP_12 = function(promise){var self = TMP_12.$$s || this, $c, $d, TMP_13;
if (promise == null) promise = nil;
      return self.handler = ($c = ($d = self).$proc, $c.$$p = (TMP_13 = function(res){var self = TMP_13.$$s || this, $e;
if (res == null) res = nil;
        if ((($e = res['$ok?']()) !== nil && $e != null && (!$e.$$is_boolean || $e == true))) {
            return promise.$resolve(res)
            } else {
            return promise.$reject(res)
          }}, TMP_13.$$s = self, TMP_13.$$arity = 1, TMP_13), $c).call($d)}, TMP_12.$$s = self, TMP_12.$$arity = 1, TMP_12), $a).call($b);
    }, TMP_14.$$arity = 0);

    Opal.defn(self, '$succeed', TMP_15 = function $$succeed(data, status, xhr) {
      var $a, self = this;
    ...
    return (Opal.defn(self, '$fail', TMP_16 = function $$fail(xhr, status, error) {
      var $a, self = this;
...
Opal.modules["todo"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$on', '$==', '$key_code', '$add_todo', '$new_item', '$[]', '$value', '$value=', '$<<', '$parse', '$new']);
  self.$require("opal");
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$initialize', TMP_2 = function $$initialize() {
      ...
      return ($a = ($b = self.$new_item()).$on, $a.$$p = (TMP_1 = function(ev){var self = TMP_1.$$s || this;
if (ev == null) ev = nil;
      if (ev.$key_code()['$=='](13)) {
          return self.$add_todo()
          } else {
          return nil
        }}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1), $a).call($b, "keyup");
    }, TMP_2.$$arity = 0);

    Opal.defn(self, '$new_item', TMP_3 = function $$new_item() {
      var self = this;

      return $scope.get('Element')['$[]']("#new_item");
    }, TMP_3.$$arity = 0);

    return (Opal.defn(self, '$add_todo', TMP_4 = function $$add_todo() {
      var $a, $b, self = this, txt = nil;

      txt = self.$new_item().$value();
      (($a = [""]), $b = self.$new_item(), $b['$value='].apply($b, $a), $a[$a.length-1]);
      return $scope.get('Element')['$[]']("#todos")['$<<']($scope.get('Element').$parse("<li>" + (txt) + "</li>"));
    }, TMP_4.$$arity = 0), nil) && 'add_todo';
  })($scope.base, null);
  return $scope.get('TodoApp').$new();
};
