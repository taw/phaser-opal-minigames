...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$flat_map', '$map', '$*', '$atlas', '$load', '$times', '$sprite', '$add', '$/', '$<<', '$width=', '$height=', '$on', '$shuffle_cats', '$input', '$shuffle!', '$each', '$frame_name=', '$shift', '$state', '$new']);
  self.$require("app/longcat"+ '/../' + "common");
  self.$require("json");
  (function($base, $super) {
    function $MainState(){};
    ...
    def.sprites = nil;
    Opal.defn(self, '$preload', function() {
      var $a, $b, TMP_1, self = this, atlas = nil;
      if ($gvars.game == null) $gvars.game = nil;

      atlas = $hash2(["frames"], {"frames": ($a = ($b = ($range(0, 3, false))).$flat_map, $a.$$p = (TMP_1 = function(x){var self = TMP_1.$$s || this, $a, $b, TMP_2;
if (x == null) x = nil;
      return ($a = ($b = ($range(0, 3, false))).$map, $a.$$p = (TMP_2 = function(y){var self = TMP_2.$$s || this;
if (y == null) y = nil;
        return $hash2(["filename", "frame"], {"filename": "longcat_" + (x) + "_" + (y), "frame": $hash2(["x", "y", "w", "h"], {"x": $rb_times(480, x), "y": $rb_times(300, y), "w": 480, "h": 300})})}, TMP_2.$$s = self, TMP_2), $a).call($b)}, TMP_1.$$s = self, TMP_1), $a).call($b)});
      return $gvars.game.$load().$atlas("longcat", "/images/longcat.jpg", nil, atlas, Phaser.Loader.TEXTURE_ATLAS_JSON_HASH);
    });

    Opal.defn(self, '$create', function() {
      var $a, $b, TMP_3, $c, TMP_5, self = this;
      if ($gvars.game == null) $gvars.game = nil;

      self.sprites = [];
      ($a = ($b = (4)).$times, $a.$$p = (TMP_3 = function(x){var self = TMP_3.$$s || this, $a, $b, TMP_4;
if (x == null) x = nil;
      return ($a = ($b = (4)).$times, $a.$$p = (TMP_4 = function(y){var self = TMP_4.$$s || this, $a, $b, longcat = nil;
          if (self.sprites == null) self.sprites = nil;
          if ($gvars.game == null) $gvars.game = nil;
          if ($gvars.size_x == null) $gvars.size_x = nil;
          if ($gvars.size_y == null) $gvars.size_y = nil;
if (y == null) y = nil;
        longcat = $gvars.game.$add().$sprite($rb_divide($rb_times($gvars.size_x, x), 4), $rb_divide($rb_times($gvars.size_y, y), 4), "longcat");
          self.sprites['$<<'](longcat);
          (($a = [$rb_divide($gvars.size_x, 4)]), $b = longcat, $b['$width='].apply($b, $a), $a[$a.length-1]);
          return (($a = [$rb_divide($gvars.size_y, 4)]), $b = longcat, $b['$height='].apply($b, $a), $a[$a.length-1]);}, TMP_4.$$s = self, TMP_4), $a).call($b)}, TMP_3.$$s = self, TMP_3), $a).call($b);
      ($a = ($c = $gvars.game.$input()).$on, $a.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this;

      return self.$shuffle_cats()}, TMP_5.$$s = self, TMP_5), $a).call($c, "down");
      return self.$shuffle_cats();
    });

    return (Opal.defn(self, '$shuffle_cats', function() {
      var $a, $b, TMP_6, $c, TMP_8, self = this, cats = nil;

      cats = [];
      ($a = ($b = (4)).$times, $a.$$p = (TMP_6 = function(x){var self = TMP_6.$$s || this, $a, $b, TMP_7;
if (x == null) x = nil;
      return ($a = ($b = (4)).$times, $a.$$p = (TMP_7 = function(y){var self = TMP_7.$$s || this;
if (y == null) y = nil;
        return cats['$<<']("longcat_" + (x) + "_" + (y))}, TMP_7.$$s = self, TMP_7), $a).call($b)}, TMP_6.$$s = self, TMP_6), $a).call($b);
      cats['$shuffle!']();
      return ($a = ($c = self.sprites).$each, $a.$$p = (TMP_8 = function(longcat){var self = TMP_8.$$s || this, $a, $b;
if (longcat == null) longcat = nil;
      return (($a = [cats.$shift()]), $b = longcat, $b['$frame_name='].apply($b, $a), $a[$a.length-1])}, TMP_8.$$s = self, TMP_8), $a).call($c);
    }), nil) && 'shuffle_cats';
