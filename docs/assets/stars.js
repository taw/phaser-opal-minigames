...
(function(Opal) {
  ...
  Opal.add_stubs(['$sprite', '$add', '$*', '$rand', '$-', '$sin', '$cos', '$x=', '$+', '$x', '$y=', '$y', '$>=', '$<=', '$-@', '$image', '$load', '$map', '$new', '$times', '$physics_elapsed', '$time', '$each', '$update', '$state']);
  self.$require("app/stars"+ '/../' + "common");
  (function($base, $super) {
    function $Star(){};
    ...
    def.star = def.dx = def.dy = nil;
    Opal.defn(self, '$initialize', function() {
      var self = this, a = nil, speed = nil;
      if ($gvars.game == null) $gvars.game = nil;
      if ($gvars.size_x == null) $gvars.size_x = nil;
      if ($gvars.size_y == null) $gvars.size_y = nil;

      self.star = $gvars.game.$add().$sprite($rb_times(self.$rand(), ($rb_minus($gvars.size_x, 24))), $rb_times(self.$rand(), ($rb_minus($gvars.size_y, 22))), "star");
      a = $rb_times($rb_times(self.$rand(), 2), (($scope.get('Math')).$$scope.get('PI')));
      speed = 500.0;
      self.dx = $rb_times(speed, $scope.get('Math').$sin(a));
      return self.dy = $rb_times(speed, $scope.get('Math').$cos(a));
    });
    ...
    return (Opal.defn(self, '$update', function(dt) {
      ...
      ($a = self.star, $a['$x=']($rb_plus($a.$x(), $rb_times(self.dx, dt))));
      ($a = self.star, $a['$y=']($rb_plus($a.$y(), $rb_times(self.dy, dt))));
      if ((($a = ((($b = $rb_ge(self.star.$x(), $rb_minus($gvars.size_x, 24))) !== false && $b !== nil) ? $b : $rb_le(self.star.$x(), 0))) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.dx = self.dx['$-@']()};
      if ((($a = ((($b = $rb_ge(self.star.$y(), $rb_minus($gvars.size_y, 22))) !== false && $b !== nil) ? $b : $rb_le(self.star.$y(), 0))) !== nil && (!$a.$$is_boolean || $a == true))) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$create', function() {
      ...
      return self.elements = ($a = ($b = (10).$times()).$map, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;
    ...
    return (Opal.defn(self, '$update', function() {
      ...
      return ($a = ($b = self.elements).$each, $a.$$p = (TMP_2 = function(element){var self = TMP_2.$$s || this;
if (element == null) element = nil;
      return element.$update(dt)}, TMP_2.$$s = self, TMP_2), $a).call($b);
    }), nil) && 'update';
