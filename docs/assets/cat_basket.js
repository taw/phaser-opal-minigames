...
(function(Opal) {
  ...
  Opal.add_stubs(['$sprite', '$add', '$set', '$anchor', '$send_new_cat!', '$x=', '$between', '$rnd', '$-', '$y=', '$+', '$y', '$*', '$x', '$/', '$down?', '$keyboard', '$input', '$clamp', '$math', '$image', '$load', '$audio', '$background_color=', '$stage', '$text', '$new', '$play', '$physics_elapsed', '$time', '$update', '$>=', '$<=', '$abs', '$cat_in_basket!', '$cat_fell_out!', '$text=', '$state']);
  self.$require("app/cat_basket"+ '/../' + "common");
  (function($base, $super) {
    function $Cat(){};
    var self = $Cat = $klass($base, $super, 'Cat', $Cat);
    ...
    Opal.defn(self, '$initialize', function() {
      ...
      return self['$send_new_cat!']();
    });

    Opal.defn(self, '$send_new_cat!', function() {
      var $a, $b, self = this;
      if ($gvars.game == null) $gvars.game = nil;
      if ($gvars.size_x == null) $gvars.size_x = nil;

      (($a = [$gvars.game.$rnd().$between(100, $rb_minus($gvars.size_x, 100))]), $b = self.cat, $b['$x='].apply($b, $a), $a[$a.length-1]);
      return (($a = [0]), $b = self.cat, $b['$y='].apply($b, $a), $a[$a.length-1]);
    });

    Opal.defn(self, '$update', function(dt) {
      var $a, self = this;

      return ($a = self.cat, $a['$y=']($rb_plus($a.$y(), $rb_times(dt, 250))));
    });
  ...
  (function($base, $super) {
    function $Basket(){};
    var self = $Basket = $klass($base, $super, 'Basket', $Basket);
    ...
    Opal.defn(self, '$initialize', function() {
      ...
      self.basket = $gvars.game.$add().$sprite($rb_divide($gvars.size_x, 2), $gvars.size_y, "basket");
      return self.basket.$anchor().$set(0.5, 0.7);
    });
    ...
    Opal.defn(self, '$update', function(dt) {
      ...
      if ((($a = $gvars.game.$input().$keyboard()['$down?'](Phaser.KeyCode.LEFT)) !== nil && (!$a.$$is_boolean || $a == true))) {
        ($a = self.basket, $a['$x=']($rb_minus($a.$x(), $rb_times(dt, 600))))};
      if ((($a = $gvars.game.$input().$keyboard()['$down?'](Phaser.KeyCode.RIGHT)) !== nil && (!$a.$$is_boolean || $a == true))) {
        ($a = self.basket, $a['$x=']($rb_plus($a.$x(), $rb_times(dt, 600))))};
      return (($a = [$gvars.game.$math().$clamp(self.basket.$x(), 110, $rb_minus($gvars.size_x, 110))]), $b = self.basket, $b['$x='].apply($b, $a), $a[$a.length-1]);
    });

    return (Opal.defn(self, '$x', function() {
      var self = this;

      return self.basket.$x();
    }), nil) && 'x';
  })($scope.base, null);
  (function($base, $super) {
    function $MainState(){};
    ...
    def.score_val = def.score = def.coin = def.cat = def.meow = def.basket = nil;
    Opal.defn(self, '$preload', function() {
      var self = this;
      if ($gvars.game == null) $gvars.game = nil;

      $gvars.game.$load().$image("cat", "/images/happy_cat.png");
      $gvars.game.$load().$image("basket", "/images/basket.png");
      $gvars.game.$load().$audio("meow2", "/audio/cat_meow_2.mp3");
    ...
    Opal.defn(self, '$create', function() {
      ...
      self.meow = $gvars.game.$add().$audio("meow2");
      (($a = ["8FB"]), $b = $gvars.game.$stage(), $b['$background_color='].apply($b, $a), $a[$a.length-1]);
      self.score_val = 0;
      self.score = $gvars.game.$add().$text($rb_divide($gvars.size_x, 8), $rb_divide($gvars.size_y, 8), self.score_val, $hash2(["fontSize", "fill", "align"], {"fontSize": "100px", "fill": "#000", "align": "center"}));
      self.score.$anchor().$set(0.5);
      self.basket = $scope.get('Basket').$new();
      return self.cat = $scope.get('Cat').$new();
    });

    Opal.defn(self, '$cat_in_basket!', function() {
      var self = this;

      self.score_val = $rb_plus(self.score_val, 1);
      self.coin.$play();
      return self.cat['$send_new_cat!']();
    });

    Opal.defn(self, '$cat_fell_out!', function() {
      var self = this;

      self.score_val = $rb_minus(self.score_val, 1);
      self.meow.$play();
      return self.cat['$send_new_cat!']();
    });
    ...
    return (Opal.defn(self, '$update', function() {
      ...
      if ((($a = $rb_ge(self.cat.$y(), $rb_minus($gvars.size_y, 10))) !== nil && (!$a.$$is_boolean || $a == true))) {
        if ((($a = $rb_le(($rb_minus(self.cat.$x(), self.basket.$x())).$abs(), 100)) !== nil && (!$a.$$is_boolean || $a == true))) {
          self['$cat_in_basket!']()
          } else {
          self['$cat_fell_out!']()
        }};
      return (($a = [self.score_val]), $b = self.score, $b['$text='].apply($b, $a), $a[$a.length-1]);
    }), nil) && 'update';
