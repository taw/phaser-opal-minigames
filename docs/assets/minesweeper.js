...
(function(Opal) {
  ...
  Opal.add_stubs(['$attr_reader', '$graphics', '$add', '$line_style', '$begin_fill', '$draw_polygon', '$==', '$visible=', '$===', '$[]=', '$text', '$set', '$anchor', '$map', '$setup_mines', '$setup_numbers', '$setup_grid', '$<', '$>=', '$revealed', '$[]', '$click_cell', '$reveal', '$c', '$auto_propagate_reveal', '$-', '$+', '$/', '$*', '$new', '$>', '$between', '$rnd', '$each', '$mines_near_xy', '$audio', '$load', '$floor', '$<=', '$size_x', '$size_y', '$grid', '$play', '$background_color=', '$stage', '$on', '$click', '$input', '$state']);
  self.$require("app/minesweeper"+ '/../' + "common");
  (function($base, $super) {
    function $Cell(){};
    ...
    def.x = def.y = def.grid_hidden = def.grid_visible = def.c = def.text = nil;
    self.$attr_reader("c", "revealed");
    ...
    Opal.defn(self, '$initialize', function(x, y, c) {
      ...
      if (self.c['$==']("X")) {
        self.grid_visible.$begin_fill(16755370)
        } else {
      ...
      $case = self.c;if ((0)['$===']($case)) {label = ""}else if ((1)['$===']($case) || (5)['$===']($case)) {style['$[]=']("fill", "#0000FF")}else if ((2)['$===']($case) || (6)['$===']($case)) {style['$[]=']("fill", "#00FF00")}else if ((3)['$===']($case) || (7)['$===']($case)) {style['$[]=']("fill", "#FF0000")}else if ((4)['$===']($case) || (8)['$===']($case)) {style['$[]=']("fill", "#FF00FF")};
      self.text = $gvars.game.$add().$text(self.x, self.y, label, style);
      self.text.$anchor().$set(0.5);
      return (($a = [false]), $b = self.text, $b['$visible='].apply($b, $a), $a[$a.length-1]);
    });

    return (Opal.defn(self, '$reveal', function() {
      var $a, $b, self = this;

      self.revealed = true;
      (($a = [true]), $b = self.text, $b['$visible='].apply($b, $a), $a[$a.length-1]);
      (($a = [false]), $b = self.grid_hidden, $b['$visible='].apply($b, $a), $a[$a.length-1]);
  ...
  (function($base, $super) {
    ...
    def.size_x = def.size_y = def.grid = def.mines = def.content = nil;
    self.$attr_reader("size_x", "size_y", "grid");
    ...
    Opal.defn(self, '$initialize', function() {
      ...
      self.size_y = 10;
      self.mines = 10;
      self.content = ($a = ($b = ($range(0, self.size_x, true))).$map, $a.$$p = (TMP_1 = function(x){var self = TMP_1.$$s || this, $a, $b, TMP_2;
        if (self.size_y == null) self.size_y = nil;
if (x == null) x = nil;
      return ($a = ($b = ($range(0, self.size_y, true))).$map, $a.$$p = (TMP_2 = function(y){var self = TMP_2.$$s || this;
if (y == null) y = nil;
        return nil}, TMP_2.$$s = self, TMP_2), $a).call($b)}, TMP_1.$$s = self, TMP_1), $a).call($b);
      self.$setup_mines();
      self.$setup_numbers();
      return self.$setup_grid();
    });

    Opal.defn(self, '$auto_propagate_reveal', function(x, y) {
      var $a, $b, self = this;

      if ((($a = ((($b = $rb_lt(x, 0)) !== false && $b !== nil) ? $b : $rb_ge(x, self.size_x))) !== nil && (!$a.$$is_boolean || $a == true))) {
        return nil};
      if ((($a = ((($b = $rb_lt(y, 0)) !== false && $b !== nil) ? $b : $rb_ge(y, self.size_y))) !== nil && (!$a.$$is_boolean || $a == true))) {
        return nil};
      if ((($a = self.grid['$[]'](x)['$[]'](y).$revealed()) !== nil && (!$a.$$is_boolean || $a == true))) {
        return nil};
      return self.$click_cell(x, y);
    });

    Opal.defn(self, '$click_cell', function(x, y) {
      var $a, self = this;
      ...
      if (self.grid['$[]'](x)['$[]'](y).$c()['$=='](0)) {
        ...
        self.$auto_propagate_reveal(x, $rb_minus(y, 1));
        self.$auto_propagate_reveal(x, $rb_plus(y, 1));
        self.$auto_propagate_reveal($rb_plus(x, 1), $rb_minus(y, 1));
        self.$auto_propagate_reveal($rb_plus(x, 1), y);
        return self.$auto_propagate_reveal($rb_plus(x, 1), $rb_plus(y, 1));
        } else {
        return nil
      };
    });
    ...
    Opal.defn(self, '$setup_grid', function() {
      ...
      return self.grid = ($a = ($b = ($range(0, self.size_x, true))).$map, $a.$$p = (TMP_3 = function(x){var self = TMP_3.$$s || this, $a, $b, TMP_4;
        if (self.size_y == null) self.size_y = nil;
if (x == null) x = nil;
      return ($a = ($b = ($range(0, self.size_y, true))).$map, $a.$$p = (TMP_4 = function(y){var self = TMP_4.$$s || this, loc_x = nil, loc_y = nil;
          if (self.content == null) self.content = nil;
          if ($gvars.size_x == null) $gvars.size_x = nil;
          if ($gvars.size_y == null) $gvars.size_y = nil;
if (y == null) y = nil;
        loc_x = $rb_plus(($rb_minus($rb_divide($gvars.size_x, 2), 180)), $rb_times(40, x));
          loc_y = $rb_plus(($rb_minus($rb_divide($gvars.size_y, 2), 180)), $rb_times(40, y));
          return $scope.get('Cell').$new(loc_x, loc_y, self.content['$[]'](x)['$[]'](y));}, TMP_4.$$s = self, TMP_4), $a).call($b)}, TMP_3.$$s = self, TMP_3), $a).call($b);
    });

    Opal.defn(self, '$setup_mines', function() {
      var $a, $b, self = this, mines_left = nil, x = nil, y = nil;
      if ($gvars.game == null) $gvars.game = nil;

      mines_left = self.mines;
      while ((($b = $rb_gt(mines_left, 0)) !== nil && (!$b.$$is_boolean || $b == true))) {
      x = $gvars.game.$rnd().$between(0, $rb_minus(self.size_x, 1));
      y = $gvars.game.$rnd().$between(0, $rb_minus(self.size_y, 1));
      if (self.content['$[]'](x)['$[]'](y)['$=='](nil)) {
        self.content['$[]'](x)['$[]='](y, "X");
        mines_left = $rb_minus(mines_left, 1);};};
    });

    Opal.defn(self, '$mines_near_xy', function(x, y) {
      var $a, $b, TMP_5, self = this, total = nil;

      total = 0;
      ($a = ($b = [$rb_minus(x, 1), x, $rb_plus(x, 1)]).$each, $a.$$p = (TMP_5 = function(xx){var self = TMP_5.$$s || this, $a, $b, TMP_6;
        if (self.size_x == null) self.size_x = nil;
if (xx == null) xx = nil;
      if ((($a = ((($b = $rb_lt(xx, 0)) !== false && $b !== nil) ? $b : $rb_ge(xx, self.size_x))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil;};
        return ($a = ($b = [$rb_minus(y, 1), y, $rb_plus(y, 1)]).$each, $a.$$p = (TMP_6 = function(yy){var self = TMP_6.$$s || this, $a, $b;
          if (self.size_y == null) self.size_y = nil;
          if (self.content == null) self.content = nil;
if (yy == null) yy = nil;
        if ((($a = ((($b = $rb_lt(yy, 0)) !== false && $b !== nil) ? $b : $rb_ge(yy, self.size_y))) !== nil && (!$a.$$is_boolean || $a == true))) {
            return nil;};
          if (self.content['$[]'](xx)['$[]'](yy)['$==']("X")) {
            return total = $rb_plus(total, 1)
            } else {
            return nil
    ...
    return (Opal.defn(self, '$setup_numbers', function() {
      var $a, $b, TMP_7, self = this;

      return ($a = ($b = ($range(0, self.size_x, true))).$each, $a.$$p = (TMP_7 = function(x){var self = TMP_7.$$s || this, $a, $b, TMP_8;
        if (self.size_y == null) self.size_y = nil;
if (x == null) x = nil;
      return ($a = ($b = ($range(0, self.size_y, true))).$each, $a.$$p = (TMP_8 = function(y){var self = TMP_8.$$s || this;
          if (self.content == null) self.content = nil;
if (y == null) y = nil;
        if (self.content['$[]'](x)['$[]'](y)['$==']("X")) {
            return nil;};
          return self.content['$[]'](x)['$[]='](y, self.$mines_near_xy(x, y));}, TMP_8.$$s = self, TMP_8), $a).call($b)}, TMP_7.$$s = self, TMP_7), $a).call($b);
    }), nil) && 'setup_numbers';
  })($scope.base, null);
  (function($base, $super) {
    function $MainState(){};
    ...
    def.board = def.meow = nil;
    Opal.defn(self, '$preload', function() {
      var self = this;
      if ($gvars.game == null) $gvars.game = nil;

      return $gvars.game.$load().$audio("meow", "/audio/cat_meow.mp3");
    });
    ...
    Opal.defn(self, '$click', function(x, y) {
      ...
      x = ($rb_divide(($rb_plus($rb_minus(x, $rb_divide($gvars.size_x, 2)), 200)), 40)).$floor();
      y = ($rb_divide(($rb_plus($rb_minus(y, $rb_divide($gvars.size_y, 2)), 200)), 40)).$floor();
    ...
    return (Opal.defn(self, '$create', function() {
      ...
      self.result = $gvars.game.$add().$text(16, 16, "Have fun playing", $hash2(["fontSize", "fill"], {"fontSize": "32px", "fill": "#fff"}));
      ...
      return ($a = ($b = $gvars.game.$input()).$on, $a.$$p = (TMP_9 = function(pointer, ev){var self = TMP_9.$$s || this;
if (pointer == null) pointer = nil;if (ev == null) ev = nil;
      return self.$click(pointer.x, pointer.y)}, TMP_9.$$s = self, TMP_9), $a).call($b, "down");
    }), nil) && 'create';
