...
(function(Opal) {
  ...
  Opal.add_stubs(['$emitter', '$add', '$make_particles', '$gravity=', '$x=', '$y=', '$start', '$maxParticleSpeed', '$minParticleSpeed', '$set_alpha', '$image', '$load', '$audio', '$background_color=', '$stage', '$start_system', '$physics', '$new', '$on', '$burst_at', '$play', '$volume=', '$input', '$state']);
  self.$require("app/cat_burst"+ '/../' + "common");
  (function($base, $super) {
    function $CatEmitter(){};
    var self = $CatEmitter = $klass($base, $super, 'CatEmitter', $CatEmitter);
    ...
    Opal.defn(self, '$initialize', function() {
      ...
      self.emitter.$make_particles("cat");
      return (($a = [200]), $b = self.emitter, $b['$gravity='].apply($b, $a), $a[$a.length-1]);
    });
    ...
    return (Opal.defn(self, '$burst_at', function(x, y) {
      ...
      return self.emitter.$start(true, 5000, nil, 5);
    }), nil) && 'burst_at';
  })($scope.base, null);
  (function($base, $super) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$preload', function() {
      ...
      $gvars.game.$load().$image("star", "/images/star2.png");
      $gvars.game.$load().$image("cat", "/images/cat-cupid-love-icon2.png");
    ...
    return (Opal.defn(self, '$create', function() {
      ...
      (($a = ["8FA"]), $b = $gvars.game.$stage(), $b['$background_color='].apply($b, $a), $a[$a.length-1]);
      $gvars.game.$physics().$start_system((((($scope.get('Phaser')).$$scope.get('Physics'))).$$scope.get('ARCADE')));
      self.star_emitter = $scope.get('StarEmitter').$new();
      self.cat_emitter = $scope.get('CatEmitter').$new();
      self.coin = $gvars.game.$add().$audio("coin");
      return ($a = ($b = $gvars.game.$input()).$on, $a.$$p = (TMP_1 = function(pointer, event){var self = TMP_1.$$s || this, $a, $b;
        if (self.star_emitter == null) self.star_emitter = nil;
        if (self.cat_emitter == null) self.cat_emitter = nil;
        if (self.coin == null) self.coin = nil;
if (pointer == null) pointer = nil;if (event == null) event = nil;
      self.star_emitter.$burst_at(pointer.x, pointer.y);
        self.cat_emitter.$burst_at(pointer.x, pointer.y);
        self.coin.$play();
        return (($a = [0.2]), $b = self.coin, $b['$volume='].apply($b, $a), $a[$a.length-1]);}, TMP_1.$$s = self, TMP_1), $a).call($b, "down");
    }), nil) && 'create';
