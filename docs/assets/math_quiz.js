...
(function(Opal) {
  ...
  Opal.add_stubs(['$attr_reader', '$text', '$add', '$*', '$set', '$anchor', '$value=', '$text=', '$attr_accessor', '$inputEnabled=', '$on', '$answered', '$events', '$background_color=', '$stage', '$new', '$new_question', '$+', '$value', '$-', '$between', '$rnd', '$sample', '$map', '$each_with_index', '$==', '$correct=', '$[]', '$shuffle', '$state']);
  self.$require("app/math_quiz"+ '/../' + "common");
  (function($base, $super) {
    function $Score(){};
    ...
    Opal.defn(self, '$initialize', function() {
      ...
      self.label = $gvars.game.$add().$text($rb_times(0.5, $gvars.size_x), $rb_times(0.1, $gvars.size_y), "", $hash2(["font", "fontSize", "fill", "align"], {"font": "Revalia", "fontSize": "80px", "fill": "#000", "align": "center"}));
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$initialize', function() {
      ...
      self.label = $gvars.game.$add().$text($rb_times(0.5, $gvars.size_x), $rb_times(0.3, $gvars.size_y), "", $hash2(["font", "fontSize", "fill", "align"], {"font": "Revalia", "fontSize": "80px", "fill": "#000", "align": "center"}));
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$initialize', function(x, y, state) {
      ...
      self.label = $gvars.game.$add().$text(x, y, "", $hash2(["font", "fontSize", "fill", "align", "backgroundColor"], {"font": "Revalia", "fontSize": "80px", "fill": "#000", "align": "center", "backgroundColor": "#8EA"}));
      self.label.$anchor().$set(0.5);
      self.correct = false;
      self.state = state;
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$create', function() {
      ...
      (($a = ["AFB"]), $b = $gvars.game.$stage(), $b['$background_color='].apply($b, $a), $a[$a.length-1]);
    ...
    return (Opal.defn(self, '$new_question', function() {
      var $a, $b, TMP_2, $c, TMP_3, self = this, a = nil, b = nil, correct = nil, fake_answers = nil;
      if ($gvars.game == null) $gvars.game = nil;

      a = $gvars.game.$rnd().$between(10, 100);
      b = $gvars.game.$rnd().$between(10, 100);
      (($a = ["" + (a) + " + " + (b)]), $b = self.question, $b['$text='].apply($b, $a), $a[$a.length-1]);
      correct = $rb_plus(a, b);
      fake_answers = ($a = ($b = [-12, -11, -10, -2, -1, 1, 2, 10, 11, 12]).$map, $a.$$p = (TMP_2 = function(fuzz){var self = TMP_2.$$s || this;
if (fuzz == null) fuzz = nil;
      return $rb_plus(fuzz, correct)}, TMP_2.$$s = self, TMP_2), $a).call($b).$sample(3);
      return ($a = ($c = self.answers.$shuffle()).$each_with_index, $a.$$p = (TMP_3 = function(answer, i){var self = TMP_3.$$s || this, $a, $b;
if (answer == null) answer = nil;if (i == null) i = nil;
      if (i['$=='](3)) {
          (($a = [correct]), $b = answer, $b['$text='].apply($b, $a), $a[$a.length-1]);
          return (($a = [true]), $b = answer, $b['$correct='].apply($b, $a), $a[$a.length-1]);
          } else {
          (($a = [fake_answers['$[]'](i)]), $b = answer, $b['$text='].apply($b, $a), $a[$a.length-1]);
          return (($a = [false]), $b = answer, $b['$correct='].apply($b, $a), $a[$a.length-1]);
