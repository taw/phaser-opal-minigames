...
/* Generated by Opal 0.9.4 */
Opal.modules["app/capitals"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;

  return Opal.cdecl($scope, 'Capitals', [["Abu Dhabi", "United Arab Emirates"], ["Abuja", "Nigeria"], ["Accra", "Ghana"], ["Adamstown", "Pitcairn"], ["Addis Ababa", "Ethiopia"], ["Algiers", "Algeria"], ["Amman", "Jordan"], ["Amsterdam", "Netherlands"], ["Andorra la Vella", "Andorra"], ["Ankara", "Turkey"], ["Antananarivo", "Madagascar"], ["Apia", "Samoa"], ["Ashgabat", "Turkmenistan"], ["Asmara", "Eritrea"], ["Astana", "Kazakhstan"], ["Asunción", "Paraguay"], ["Athens", "Greece"], ["Baghdad", "Iraq"], ["Baku", "Azerbaijan"], ["Bamako", "Mali"], ["Bandar Seri Begawan", "Brunei"], ["Bangkok", "Thailand"], ["Bangui", "Central African Republic"], ["Banjul", "Gambia"], ["Basseterre", "Saint Kitts and Nevis"], ["Beijing", "People's Republic of China"], ["Beirut", "Lebanon"], ["Belgrade", "Serbia"], ["Belmopan", "Belize"], ["Berlin", "Germany"], ["Bern", "Switzerland"], ["Bishkek", "Kyrgyzstan"], ["Bissau", "Guinea-Bissau"], ["Bogotá", "Colombia"], ["Brasília", "Brazil"], ["Bratislava", "Slovakia"], ["Brazzaville", "Republic of the Congo"], ["Bridgetown", "Barbados"], ["Brussels", "Belgium"], ["Bucharest", "Romania"], ["Budapest", "Hungary"], ["Buenos Aires", "Argentina"], ["Bujumbura", "Burundi"], ["Cairo", "Egypt"], ["Canberra", "Australia"], ["Caracas", "Venezuela"], ["Castries", "Saint Lucia"], ["Chișinău", "Moldova"], ["Conakry", "Guinea"], ["Copenhagen", "Denmark"], ["Dakar", "Senegal"], ["Damascus", "Syria"], ["Dhaka", "Bangladesh"], ["Dili", "East Timor"], ["Djibouti", "Djibouti"], ["Dodoma", "Tanzania"], ["Doha", "Qatar"], ["Dublin", "Ireland"], ["Dushanbe", "Tajikistan"], ["Freetown", "Sierra Leone"], ["Funafuti", "Tuvalu"], ["Gaborone", "Botswana"], ["Georgetown", "Guyana"], ["Guatemala City", "Guatemala"], ["Hanoi", "Vietnam"], ["Harare", "Zimbabwe"], ["Havana", "Cuba"], ["Helsinki", "Finland"], ["Honiara", "Solomon Islands"], ["Islamabad", "Pakistan"], ["Jakarta", "Indonesia"], ["Tel Aviv", "Israel"], ["Juba", "South Sudan"], ["Kabul", "Afghanistan"], ["Kampala", "Uganda"], ["Kathmandu", "Nepal"], ["Khartoum", "Sudan"], ["Kiev", "Ukraine"], ["Kigali", "Rwanda"], ["Kingston", "Jamaica"], ["Kingstown", "Saint Vincent and the Grenadines"], ["Kinshasa", "Democratic Republic of the Congo"], ["Kuala Lumpur", "Malaysia"], ["Kuwait City", "Kuwait"], ["Libreville", "Gabon"], ["Lilongwe", "Malawi"], ["Lima", "Peru"], ["Lisbon", "Portugal"], ["Ljubljana", "Slovenia"], ["Lomé", "Togo"], ["London", "United Kingdom"], ["Luanda", "Angola"], ["Lusaka", "Zambia"], ["Luxembourg", "Luxembourg"], ["Madrid", "Spain"], ["Majuro", "Marshall Islands"], ["Malabo", "Equatorial Guinea"], ["Malé", "Maldives"], ["Managua", "Nicaragua"], ["Manama", "Bahrain"], ["Manila", "Philippines"], ["Maputo", "Mozambique"], ["Maseru", "Lesotho"], ["Lobamba", "Swaziland"], ["Mexico City", "Mexico"], ["Minsk", "Belarus"], ["Mogadishu", "Somalia"], ["Monaco", "Monaco"], ["Monrovia", "Liberia"], ["Montevideo", "Uruguay"], ["Moroni", "Comoros"], ["Moscow", "Russia"], ["Muscat", "Oman"], ["Nairobi", "Kenya"], ["Nassau", "Bahamas"], ["Naypyidaw", "Myanmar"], ["N'Djamena", "Chad"], ["New Delhi", "India"], ["Ngerulmud", "Palau"], ["Niamey", "Niger"], ["Nicosia", "Cyprus"], ["Nouakchott", "Mauritania"], ["Nouméa", "New Caledonia"], ["Nukuʻalofa", "Tonga"], ["Oslo", "Norway"], ["Ottawa", "Canada"], ["Ouagadougou", "Burkina Faso"], ["Palikir", "Federated States of Micronesia"], ["Panama City", "Panama"], ["Paramaribo", "Suriname"], ["Paris", "France"], ["Phnom Penh", "Cambodia"], ["Podgorica", "Montenegro"], ["Port Louis", "Mauritius"], ["Port Moresby", "Papua New Guinea"], ["Port Vila", "Vanuatu"], ["Port-au-Prince", "Haiti"], ["Port of Spain", "Trinidad and Tobago"], ["Porto-Novo", "Benin"], ["Prague", "Czech Republic"], ["Praia", "Cabo Verde"], ["Cape Town", "South Africa"], ["Pyongyang", "North Korea"], ["Quito", "Ecuador"], ["Rabat", "Morocco"], ["Reykjavík", "Iceland"], ["Riga", "Latvia"], ["Riyadh", "Saudi Arabia"], ["Road Town", "British Virgin Islands"], ["Rome", "Italy"], ["Roseau", "Dominica"], ["San José", "Costa Rica"], ["San Marino", "San Marino"], ["San Salvador", "El Salvador"], ["Sana'a", "Yemen"], ["Santiago", "Chile"], ["Santo Domingo", "Dominican Republic"], ["São Tomé", "São Tomé and Príncipe"], ["Sarajevo", "Bosnia and Herzegovina"], ["Seoul", "South Korea"], ["Singapore", "Singapore"], ["Skopje", "Republic of Macedonia"], ["Sofia", "Bulgaria"], ["Sri Jayawardenepura Kotte", "Sri Lanka"], ["St. George's", "Grenada"], ["St. John's", "Antigua and Barbuda"], ["Stockholm", "Sweden"], ["Sucre", "Bolivia"], ["Suva", "Fiji"], ["Taipei", "Republic of China"], ["Tallinn", "Estonia"], ["Tarawa", "Kiribati"], ["Tashkent", "Uzbekistan"], ["Tbilisi", "Georgia"], ["Tegucigalpa", "Honduras"], ["Tehran", "Iran"], ["Thimphu", "Bhutan"], ["Tirana", "Albania"], ["Tokyo", "Japan"], ["Tripoli", "Libya"], ["Tskhinvali", "South Ossetia"], ["Tunis", "Tunisia"], ["Ulaanbaatar", "Mongolia"], ["Vaduz", "Liechtenstein"], ["Valletta", "Malta"], ["Vatican City", "Vatican City"], ["Victoria", "Seychelles"], ["Vienna", "Austria"], ["Vientiane", "Laos"], ["Vilnius", "Lithuania"], ["Warsaw", "Poland"], ["Washington, D.C.", "United States"], ["Wellington", "New Zealand"], ["Windhoek", "Namibia"], ["Yamoussoukro", "Côte d'Ivoire"], ["Yaoundé", "Cameroon"], ["Yaren", "Nauru"], ["Yerevan", "Armenia"], ["Zagreb", "Croatia"]])
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$attr_reader', '$text', '$add', '$*', '$set', '$anchor', '$value=', '$text=', '$attr_accessor', '$inputEnabled=', '$on', '$answered', '$events', '$background_color=', '$stage', '$new', '$new_question', '$+', '$value', '$-', '$sample', '$[]', '$each_with_index', '$correct=', '$==', '$shuffle', '$state']);
  self.$require("app/geography_quiz"+ '/../' + "common");
  self.$require("app/geography_quiz"+ '/../' + "capitals");
  (function($base, $super) {
    function $Score(){};
    ...
    Opal.defn(self, '$initialize', function() {
      ...
      self.label = $gvars.game.$add().$text($rb_times(0.5, $gvars.size_x), $rb_times(0.1, $gvars.size_y), "", $hash2(["font", "fontSize", "fill", "align"], {"font": "Raleway", "fontSize": "80px", "fill": "#000", "align": "center"}));
      self.label.$anchor().$set(0.5);
      return (($a = [0]), $b = self, $b['$value='].apply($b, $a), $a[$a.length-1]);
    });

    return (Opal.defn(self, '$value=', function(v) {
      var $a, $b, self = this;

      self.value = v;
      return (($a = ["Score: " + (self.value)]), $b = self.label, $b['$text='].apply($b, $a), $a[$a.length-1]);
    }), nil) && 'value=';
  })($scope.base, null);
  (function($base, $super) {
    function $Question(){};
    var self = $Question = $klass($base, $super, 'Question', $Question);
    ...
    Opal.defn(self, '$initialize', function() {
      ...
      self.label = $gvars.game.$add().$text($rb_times(0.5, $gvars.size_x), $rb_times(0.3, $gvars.size_y), "", $hash2(["fontWeight", "font", "fontSize", "fill", "align"], {"fontWeight": "bold", "font": "Raleway", "fontSize": "60px", "fill": "#000", "align": "center"}));
      return self.label.$anchor().$set(0.5);
    });

    return (Opal.defn(self, '$text=', function(v) {
      var $a, $b, self = this;

      return (($a = [v]), $b = self.label, $b['$text='].apply($b, $a), $a[$a.length-1]);
    }), nil) && 'text=';
  })($scope.base, null);
  (function($base, $super) {
    function $Answer(){};
    var self = $Answer = $klass($base, $super, 'Answer', $Answer);

    var def = self.$$proto, $scope = self.$$scope;

    def.label = nil;
    self.$attr_accessor("correct");

    Opal.defn(self, '$initialize', function(x, y, state) {
      var $a, $b, TMP_1, self = this;
      if ($gvars.game == null) $gvars.game = nil;

      self.label = $gvars.game.$add().$text(x, y, "", $hash2(["font", "fontSize", "fill", "align", "backgroundColor"], {"font": "Raleway", "fontSize": "60px", "fill": "#E6F8F6", "align": "center", "backgroundColor": "#03414D"}));
      self.label.$anchor().$set(0.5);
      self.correct = false;
      self.state = state;
      (($a = [true]), $b = self.label, $b['$inputEnabled='].apply($b, $a), $a[$a.length-1]);
      return ($a = ($b = self.label.$events()).$on, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;
        if (self.state == null) self.state = nil;
        if (self.correct == null) self.correct = nil;

      return self.state.$answered(self.correct)}, TMP_1.$$s = self, TMP_1), $a).call($b, "down");
    });
  ...
  (function($base, $super) {
    ...
    def.score = def.question = def.answers = nil;
    Opal.defn(self, '$create', function() {
      var $a, $b, self = this;
      if ($gvars.game == null) $gvars.game = nil;
      if ($gvars.size_x == null) $gvars.size_x = nil;
      ...
      (($a = ["#72DFD0"]), $b = $gvars.game.$stage(), $b['$background_color='].apply($b, $a), $a[$a.length-1]);
      self.score = $scope.get('Score').$new();
      self.question = $scope.get('Question').$new();
      self.answers = [$scope.get('Answer').$new($rb_times(0.25, $gvars.size_x), $rb_times(0.5, $gvars.size_y), self), $scope.get('Answer').$new($rb_times(0.75, $gvars.size_x), $rb_times(0.5, $gvars.size_y), self), $scope.get('Answer').$new($rb_times(0.25, $gvars.size_x), $rb_times(0.7, $gvars.size_y), self), $scope.get('Answer').$new($rb_times(0.75, $gvars.size_x), $rb_times(0.7, $gvars.size_y), self)];
      return self.$new_question();
    });

    Opal.defn(self, '$answered', function(correct) {
      var $a, self = this;

      if (correct !== false && correct !== nil) {
        ($a = self.score, $a['$value=']($rb_plus($a.$value(), 1)))
        } else {
        ($a = self.score, $a['$value=']($rb_minus($a.$value(), 1)))
      };
      return self.$new_question();
    });

    return (Opal.defn(self, '$new_question', function() {
      var $a, $b, TMP_2, self = this, countries = nil;

      countries = $scope.get('Capitals').$sample(4);
      (($a = ["Capital of " + (countries['$[]'](0)['$[]'](1))]), $b = self.question, $b['$text='].apply($b, $a), $a[$a.length-1]);
      return ($a = ($b = self.answers.$shuffle()).$each_with_index, $a.$$p = (TMP_2 = function(answer, i){var self = TMP_2.$$s || this, $a, $b;
if (answer == null) answer = nil;if (i == null) i = nil;
      (($a = [countries['$[]'](i)['$[]'](0)]), $b = answer, $b['$text='].apply($b, $a), $a[$a.length-1]);
        return (($a = [(i['$=='](0))]), $b = answer, $b['$correct='].apply($b, $a), $a[$a.length-1]);}, TMP_2.$$s = self, TMP_2), $a).call($b);
    }), nil) && 'new_question';
