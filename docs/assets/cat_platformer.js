...
(function(Opal) {
  ...
  self.$require("app/cat_platformer"+ '/../' + "common");
  (function($base, $super) {
    function $MainState(){};
    ...
    def.platforms = def.player = def.cursors = def.jumpButton = nil;
    Opal.defn(self, '$preload', function() {
      var self = this;
      if ($gvars.game == null) $gvars.game = nil;

      $gvars.game.$load().$image("cat", "/images/cat_images/cat17.png");
      return $gvars.game.$load().$image("platform", "/images/grass_platform.png");
    });

    Opal.defn(self, '$add_platform', function(x, y) {
      var $a, $b, self = this, platform = nil;

      platform = self.platforms.$create(x, y, "platform");
      (($a = [40]), $b = platform, $b['$height='].apply($b, $a), $a[$a.length-1]);
      (($a = [200]), $b = platform, $b['$width='].apply($b, $a), $a[$a.length-1]);
    ...
    return (Opal.defn(self, '$create', function() {
      ...
      (($a = [64]), $b = self.player, $b['$height='].apply($b, $a), $a[$a.length-1]);
