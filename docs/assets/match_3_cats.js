...
(function(Opal) {
  ...
  self.$require("app/match_3_cats"+ '/../' + "common");
  (function($base, $super) {
    function $Sprite(){};
    var self = $Sprite = $klass($base, $super, 'Sprite', $Sprite);
    ...
    return self.$attr_accessor("c")
  })($scope.get('Phaser'), null);
  (function($base, $super) {
    function $Board(){};
    ...
    def.size_x = def.grid = def.active = nil;
    self.$attr_reader("matches");
    ...
    Opal.defn(self, '$initialize', function() {
      ...
      self.size_y = 8;
      self.active = true;
      return self.grid = ($a = ($b = ($range(0, self.size_x, true))).$map, $a.$$p = (TMP_1 = function(x){var self = TMP_1.$$s || this, $a, $b, TMP_2;
        if (self.size_y == null) self.size_y = nil;
if (x == null) x = nil;
      return ($a = ($b = ($range(0, self.size_y, true))).$map, $a.$$p = (TMP_2 = function(y){var self = TMP_2.$$s || this, $a, $b, loc_x = nil, loc_y = nil, c = nil, tile = nil;
          if ($gvars.size_x == null) $gvars.size_x = nil;
          if ($gvars.size_y == null) $gvars.size_y = nil;
          if ($gvars.game == null) $gvars.game = nil;
if (y == null) y = nil;
        loc_x = $rb_plus($rb_divide($gvars.size_x, 2), $rb_times(80, ($rb_minus(x, 3.5))));
          loc_y = $rb_plus($rb_divide($gvars.size_y, 2), $rb_times(80, ($rb_minus(y, 3.5))));
          c = $gvars.game.$rnd().$between(0, 6);
          tile = $gvars.game.$add().$sprite(loc_x, loc_y, "cat" + (c));
          (($a = [c]), $b = tile, $b['$c='].apply($b, $a), $a[$a.length-1]);
          tile.$anchor().$set(0.5, 0.5);
          (($a = [64]), $b = tile, $b['$height='].apply($b, $a), $a[$a.length-1]);
          (($a = [64]), $b = tile, $b['$width='].apply($b, $a), $a[$a.length-1]);
          return tile;}, TMP_2.$$s = self, TMP_2), $a).call($b)}, TMP_1.$$s = self, TMP_1), $a).call($b);
    });

    Opal.defn(self, '$set_tile', function(x, y, c) {
      var $a, $b, self = this;

      (($a = [c]), $b = self.grid['$[]'](x)['$[]'](y), $b['$c='].apply($b, $a), $a[$a.length-1]);
      return self.grid['$[]'](x)['$[]'](y).$load_texture("cat" + (c));
    });

    Opal.defn(self, '$rotate', function(x, y) {
      var $a, $b, TMP_3, self = this, t0 = nil, t1 = nil, t2 = nil, t3 = nil;
      if ($gvars.game == null) $gvars.game = nil;
      ...
      self.grid['$[]'](x)['$[]=']($rb_plus(y, 1), t2);
      self.active = false;
      return ($a = ($b = $gvars.game.$time().$events()).$add, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

      return self.active = true}, TMP_3.$$s = self, TMP_3), $a).call($b, 500);
    });

    Opal.defn(self, '$remove_matches', function() {
      var self = this;

      return false;
    });

    return (Opal.defn(self, '$find_matches', function() {
      var $a, $b, TMP_4, self = this;

      self.matches = [];
      return ($a = ($b = ($range(0, self.size_x, true))).$each, $a.$$p = (TMP_4 = function(x){var self = TMP_4.$$s || this, $a, $b, TMP_5;
        if (self.size_y == null) self.size_y = nil;
if (x == null) x = nil;
      return ($a = ($b = ($range(0, self.size_y, true))).$each, $a.$$p = (TMP_5 = function(y){var self = TMP_5.$$s || this, $a, $b, TMP_6, $c, TMP_7;
...
if (yy == null) yy = nil;
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$preload', function() {
      ...
      return ($a = ($b = [3, 4, 11, 13, 17, 18, 20]).$each_with_index, $a.$$p = (TMP_8 = function(i, j){var self = TMP_8.$$s || this;
        if ($gvars.game == null) $gvars.game = nil;
if (i == null) i = nil;if (j == null) j = nil;
      return $gvars.game.$load().$image("cat" + (j), "../images/cat_images/cat" + (i) + ".png")}, TMP_8.$$s = self, TMP_8), $a).call($b);
    });

    Opal.defn(self, '$rotation_position', function() {
      var self = this, mx = nil, my = nil, cx = nil, cy = nil;
      if ($gvars.game == null) $gvars.game = nil;
      if ($gvars.size_x == null) $gvars.size_x = nil;
      if ($gvars.size_y == null) $gvars.size_y = nil;

      mx = $gvars.game.$input().$mouse_pointer().$worldX();
      my = $gvars.game.$input().$mouse_pointer().$worldY();
      cx = ($rb_plus(($rb_divide(($rb_minus(mx, $rb_divide($gvars.size_x, 2))), 80)), 3.5)).$floor();
      cy = ($rb_plus(($rb_divide(($rb_minus(my, $rb_divide($gvars.size_y, 2))), 80)), 3.5)).$floor();
      cx = $gvars.game.$math().$clamp(cx, 0, 6);
      cy = $gvars.game.$math().$clamp(cy, 0, 6);
      return [cx, cy];
    });

    Opal.defn(self, '$update', function() {
      var $a, $b, self = this, cx = nil, cy = nil;
      if ($gvars.size_x == null) $gvars.size_x = nil;
      if ($gvars.size_y == null) $gvars.size_y = nil;

      $b = self.$rotation_position(), $a = Opal.to_ary($b), cx = ($a[0] == null ? nil : $a[0]), cy = ($a[1] == null ? nil : $a[1]), $b;
      (($a = [$rb_plus($rb_divide($gvars.size_x, 2), $rb_times(80, ($rb_minus(cx, 3))))]), $b = self.rotation, $b['$x='].apply($b, $a), $a[$a.length-1]);
      return (($a = [$rb_plus($rb_divide($gvars.size_y, 2), $rb_times(80, ($rb_minus(cy, 3))))]), $b = self.rotation, $b['$y='].apply($b, $a), $a[$a.length-1]);
    });
    ...
    return (Opal.defn(self, '$create', function() {
      ...
      self.rotation = $gvars.game.$add().$graphics(0, 0);
      self.rotation.$line_style(5, 16711680);
      self.rotation.$draw_circle(0, 0, 160);
      return ($a = ($b = $gvars.game.$input()).$on, $a.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this, $a, $b, cx = nil, cy = nil;
        if (self.board == null) self.board = nil;

      $b = self.$rotation_position(), $a = Opal.to_ary($b), cx = ($a[0] == null ? nil : $a[0]), cy = ($a[1] == null ? nil : $a[1]), $b;
        self.board.$rotate(cx, cy);
        self.board.$find_matches();
        return self.$p(self.board.$matches());}, TMP_9.$$s = self, TMP_9), $a).call($b, "tap");
    }), nil) && 'create';
