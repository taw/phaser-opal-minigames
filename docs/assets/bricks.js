...
(function(Opal) {
  ...
  self.$require("app/bricks"+ '/../' + "common");
  (function($base, $super) {
    function $Brick(){};
    ...
    def.x = def.y = def.brick = def.brick_x_size = def.brick_y_size = nil;
    self.$attr_reader("brick_x_size", "brick_y_size");
  ...
  (function($base, $super) {
    ...
    def.ball = def.dx = def.dy = nil;
    self.$attr_accessor("dx", "dy");
    ...
    Opal.defn(self, '$initialize', function() {
      ...
      self.ball = $gvars.game.$add().$graphics($rb_times(0.5, $gvars.size_x), $rb_times(0.8, $gvars.size_y));
      self.ball.$begin_fill(0);
      self.ball.$draw_rect(-10, -10, 20, 20);
      self.dx = 300;
      return self.dy = -300;
    });
    ...
    Opal.defn(self, '$update', function(dt) {
      ...
      ($a = self.ball, $a['$x=']($rb_plus($a.$x(), $rb_times(self.dx, dt))));
      ($a = self.ball, $a['$y=']($rb_plus($a.$y(), $rb_times(self.dy, dt))));
      if ((($a = ($b = $rb_le(self.ball.$x(), 10), $b !== false && $b !== nil ?$rb_lt(self.dx, 0) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.dx = self.dx['$-@']()};
      if ((($a = ($b = $rb_ge(self.ball.$x(), $rb_minus($gvars.size_x, 10)), $b !== false && $b !== nil ?$rb_gt(self.dx, 0) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.dx = self.dx['$-@']()};
      if ((($a = ($b = $rb_le(self.ball.$y(), 10), $b !== false && $b !== nil ?$rb_lt(self.dy, 0) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$initialize', function() {
      ...
      self.paddle = $gvars.game.$add().$graphics($rb_times(0.5, $gvars.size_x), $rb_minus($gvars.size_y, 20));
      self.paddle.$begin_fill(255);
      return self.paddle.$draw_rect(-50, -10, 100, 20);
    });

    Opal.defn(self, '$update', function(dt, direction) {
      var $a, $b, self = this;
      if ($gvars.game == null) $gvars.game = nil;
      if ($gvars.size_x == null) $gvars.size_x = nil;
...
if (y == null) y = nil;
    ...
    Opal.defn(self, '$handle_brick_colission', function(brick) {
      var $a, $b, self = this, distance_x = nil, distance_y = nil;

      if ((($a = brick.$destroyed()) !== nil && (!$a.$$is_boolean || $a == true))) {
        return nil};
      distance_x = $rb_divide(($rb_minus(brick.$x(), self.ball.$x())), ($rb_plus(10, $rb_divide(brick.$brick_x_size(), 2))));
    ...
    return (Opal.defn(self, '$update', function() {
      var $a, $b, TMP_3, $c, $d, self = this, dt = nil, paddle_distance = nil, bottom_distance = nil;
      if ($gvars.game == null) $gvars.game = nil;
      if ($gvars.size_y == null) $gvars.size_y = nil;
      ...
      if ((($a = $gvars.game.$input().$keyboard()['$down?'](Phaser.KeyCode.RIGHT)) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.paddle.$update(dt, 1)
      } else if ((($a = $gvars.game.$input().$keyboard()['$down?'](Phaser.KeyCode.LEFT)) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.paddle.$update(dt, -1)};
      self.ball_bounce_x = false;
      self.ball_bounce_y = false;
      ($a = ($b = self.bricks).$each, $a.$$p = (TMP_3 = function(brick){var self = TMP_3.$$s || this;
if (brick == null) brick = nil;
      return self.$handle_brick_colission(brick)}, TMP_3.$$s = self, TMP_3), $a).call($b);
      if ((($a = self.ball_bounce_x) !== nil && (!$a.$$is_boolean || $a == true))) {
        (($a = [self.ball.$dx()['$-@']()]), $c = self.ball, $c['$dx='].apply($c, $a), $a[$a.length-1])};
      if ((($a = self.ball_bounce_y) !== nil && (!$a.$$is_boolean || $a == true))) {
        (($a = [self.ball.$dy()['$-@']()]), $c = self.ball, $c['$dy='].apply($c, $a), $a[$a.length-1])};
      paddle_distance = ($rb_minus(self.paddle.$x(), self.ball.$x())).$abs();
      ...
      if ((($a = $rb_gt(self.ball.$dy(), 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
        if ((($a = ($c = $rb_le(bottom_distance, 30), $c !== false && $c !== nil ?$rb_le(paddle_distance, 60) : $c)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          self.active = false;}};
      if ((($a = ($c = ($d = self.bricks)['$all?'], $c.$$p = "destroyed".$to_proc(), $c).call($d)) !== nil && (!$a.$$is_boolean || $a == true))) {
        (($a = ["FFF"]), $c = $gvars.game.$stage(), $c['$background_color='].apply($c, $a), $a[$a.length-1]);
